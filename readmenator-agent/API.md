...
### check (function) `def check(name, cond, detail)`
...
### _ent (function) `def _ent(etype, value, source)`
...
### test_transliteration (function) `def test_transliteration()`
- Defined: `_test_entity_resolution.py:47`
- Depends on: `estorides_core/entity_extraction.py`, `estorides_core/entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/transliteration.py`

### test_jaro_winkler (function) `def test_jaro_winkler()`
- Defined: `_test_entity_resolution.py:63`
- Depends on: `estorides_core/entity_extraction.py`, `estorides_core/entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/transliteration.py`

### test_normalization (function) `def test_normalization()`
- Defined: `_test_entity_resolution.py:74`
- Depends on: `estorides_core/entity_extraction.py`, `estorides_core/entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/transliteration.py`

### test_score_pair_policy (function) `def test_score_pair_policy()`
- Defined: `_test_entity_resolution.py:98`
- Depends on: `estorides_core/entity_extraction.py`, `estorides_core/entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/transliteration.py`

### test_resolution_merge (function) `def test_resolution_merge()`
- Defined: `_test_entity_resolution.py:111`
- Depends on: `estorides_core/entity_extraction.py`, `estorides_core/entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/transliteration.py`

### test_to_entity_roundtrip (function) `def test_to_entity_roundtrip()`
- Defined: `_test_entity_resolution.py:167`
- Depends on: `estorides_core/entity_extraction.py`, `estorides_core/entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/transliteration.py`

### test_cross_run_stability (function) `def test_cross_run_stability()`
- Defined: `_test_entity_resolution.py:182`
- Depends on: `estorides_core/entity_extraction.py`, `estorides_core/entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/transliteration.py`

### test_empty_and_edge_inputs (function) `def test_empty_and_edge_inputs()`
...
### check (function) `def check(label, cond)`
- Defined: `_test_fusion.py:24`
- Depends on: `estorides_core/fusion_store.py`

### _fresh_store (function) `def _fresh_store()`
- Defined: `_test_fusion.py:32`
- Depends on: `estorides_core/fusion_store.py`

### test_deterministic_identity (function) `def test_deterministic_identity()`
- Defined: `_test_fusion.py:37`
- Depends on: `estorides_core/fusion_store.py`

### test_cross_run_dedup_and_provenance (function) `def test_cross_run_dedup_and_provenance()`
- Defined: `_test_fusion.py:45`
- Depends on: `estorides_core/fusion_store.py`

### test_property_corroboration_and_conflict (function) `def test_property_corroboration_and_conflict()`
- Defined: `_test_fusion.py:59`
- Depends on: `estorides_core/fusion_store.py`

### test_min_sources_filter (function) `def test_min_sources_filter()`
- Defined: `_test_fusion.py:76`
- Depends on: `estorides_core/fusion_store.py`

### test_relationship_fusion (function) `def test_relationship_fusion()`
- Defined: `_test_fusion.py:87`
- Depends on: `estorides_core/fusion_store.py`

### test_observation_and_source_counters (function) `def test_observation_and_source_counters()`
- Defined: `_test_fusion.py:97`
- Depends on: `estorides_core/fusion_store.py`

### test_fail_soft_open (function) `def test_fail_soft_open()`
...
### _ok (function) `def _ok(name, ok, detail)`
...
### test_security_headers (function) `def test_security_headers()`
- Defined: `_test_hardening.py:36`
- Depends on: `estorides_core/__init__.py`, `estorides_core/cases.py`, `estorides_export/report.py`, `wsgi.py`

### test_cors_default_off (function) `def test_cors_default_off()`
- Defined: `_test_hardening.py:53`
- Doc: Without ESTORIDES_CORS_ORIGINS, CORS headers must not be emitted.
- Depends on: `estorides_core/__init__.py`, `estorides_core/cases.py`, `estorides_export/report.py`, `wsgi.py`

### test_cors_allowlist (function) `def test_cors_allowlist()`
- Defined: `_test_hardening.py:62`
- Doc: With an allowlist, only matching origins get a CORS header.
- Depends on: `estorides_core/__init__.py`, `estorides_core/cases.py`, `estorides_export/report.py`, `wsgi.py`

### test_debug_killswitch (function) `def test_debug_killswitch()`
- Defined: `_test_hardening.py:87`
- Doc: When DEBUG is on, install_security must refuse to run.
- Depends on: `estorides_core/__init__.py`, `estorides_core/cases.py`, `estorides_export/report.py`, `wsgi.py`

### test_max_body_rejection (function) `def test_max_body_rejection()`
- Defined: `_test_hardening.py:101`
- Doc: A request body larger than MAX_CONTENT_LENGTH must be rejected.
- Depends on: `estorides_core/__init__.py`, `estorides_core/cases.py`, `estorides_export/report.py`, `wsgi.py`

### test_case_diff (function) `def test_case_diff()`
- Defined: `_test_hardening.py:113`
- Depends on: `estorides_core/__init__.py`, `estorides_core/cases.py`, `estorides_export/report.py`, `wsgi.py`

### test_case_diff_endpoints (function) `def test_case_diff_endpoints()`
- Defined: `_test_hardening.py:137`
- Depends on: `estorides_core/__init__.py`, `estorides_core/cases.py`, `estorides_export/report.py`, `wsgi.py`

### test_case_save_endpoint (function) `def test_case_save_endpoint()`
- Defined: `_test_hardening.py:148`
- Depends on: `estorides_core/__init__.py`, `estorides_core/cases.py`, `estorides_export/report.py`, `wsgi.py`

### test_report_renders (function) `def test_report_renders()`
- Defined: `_test_hardening.py:165`
- Depends on: `estorides_core/__init__.py`, `estorides_core/cases.py`, `estorides_export/report.py`, `wsgi.py`

### test_report_with_diff (function) `def test_report_with_diff()`
- Defined: `_test_hardening.py:181`
- Depends on: `estorides_core/__init__.py`, `estorides_core/cases.py`, `estorides_export/report.py`, `wsgi.py`

### test_console_script_help (function) `def test_console_script_help()`
...
### _enter_and_rotate (function) `def _enter_and_rotate()`
- Defined: `_test_proxy.py:52`
- Depends on: `estorides_core/__init__.py`, `estorides_core/async_client.py`, `estorides_core/config.py`

### _enter_socks (function) `def _enter_socks()`
...
- Defined: `estorides_cli.py:683`
- Depends on: `estorides_core/alerter.py`, `estorides_core/cases.py`, `estorides_core/config.py`, `estorides_core/discoverer.py`, `estorides_core/entity_extraction.py`, `estorides_core/fusion_store.py`, `estorides_core/knowledge_graph.py`, `estorides_core/monitoring.py`, `estorides_core/orchestrator.py`, `estorides_core/scope.py`, `estorides_core/validation.py`, `estorides_export/__init__.py`, `estorides_export/report.py`, `estorides_web.py`
- Imported by: `tests/test_cli_watch.py`, `tests/test_cli_watch.py`

### build_parser (function) `def build_parser()`
- Defined: `estorides_cli.py:700`
- Depends on: `estorides_core/alerter.py`, `estorides_core/cases.py`, `estorides_core/config.py`, `estorides_core/discoverer.py`, `estorides_core/entity_extraction.py`, `estorides_core/fusion_store.py`, `estorides_core/knowledge_graph.py`, `estorides_core/monitoring.py`, `estorides_core/orchestrator.py`, `estorides_core/scope.py`, `estorides_core/validation.py`, `estorides_export/__init__.py`, `estorides_export/report.py`, `estorides_web.py`
- Imported by: `tests/test_cli_watch.py`, `tests/test_cli_watch.py`

### main (function) `def main(argv)`
- Defined: `estorides_cli.py:856`
- Depends on: `estorides_core/alerter.py`, `estorides_core/cases.py`, `estorides_core/config.py`, `estorides_core/discoverer.py`, `estorides_core/entity_extraction.py`, `estorides_core/fusion_store.py`, `estorides_core/knowledge_graph.py`, `estorides_core/monitoring.py`, `estorides_core/orchestrator.py`, `estorides_core/scope.py`, `estorides_core/validation.py`, `estorides_export/__init__.py`, `estorides_export/report.py`, `estorides_web.py`
- Imported by: `tests/test_cli_watch.py`, `tests/test_cli_watch.py`
...
### _reliability_weight (method) `def _reliability_weight(name)`
...
- Depends on: `estorides_core/config.py`
- Imported by: `_test_entity_resolution.py`, `_test_people.py`, `estorides_cli.py`, `estorides_cli.py`, `estorides_core/entity_resolution.py`, `estorides_core/knowledge_graph.py`, `estorides_core/orchestrator.py`, `estorides_core/tool_runner.py`, `estorides_core/validation.py`, `estorides_web.py`, `estorides_web.py`, `tests/test_encrypted_export.py`, `tests/test_entity_extraction.py`, `tests/test_entity_resolution.py`, `tests/test_socmint.py`
...
- Defined: `estorides_core/entity_resolution.py:260`
...
- Defined: `estorides_core/entity_resolution.py:305`
- Doc: Score how likely two same-type entities denote the same object.
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### _script_of (method) `def _script_of(value)`
- Defined: `estorides_core/entity_resolution.py:453`
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### resolve_entities (method) `def resolve_entities(entities)`
- Defined: `estorides_core/entity_resolution.py:730`
- Doc: Module-level convenience wrapper around :class:`EntityResolver`.
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### to_dict (method) `def to_dict(self)`
- Defined: `estorides_core/entity_resolution.py:360`
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### to_entity (method) `def to_entity(self)`
- Defined: `estorides_core/entity_resolution.py:376`
- Doc: Project back onto the legacy :class:`Entity` shape.
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### to_dict (method) `def to_dict(self)`
- Defined: `estorides_core/entity_resolution.py:412`
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### to_dict (method) `def to_dict(self)`
- Defined: `estorides_core/entity_resolution.py:428`
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`
...
- Defined: `estorides_core/entity_resolution.py:441`
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### union (method) `def union(self, a, b)`
- Defined: `estorides_core/entity_resolution.py:447`
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### __init__ (method) `def __init__(self)`
- Defined: `estorides_core/entity_resolution.py:472`
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### resolve (method) `def resolve(self, entities)`
- Defined: `estorides_core/entity_resolution.py:485`
- Doc: Resolve ``entities`` into canonical identities and links.
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### _build_records (method) `def _build_records(self, entities)`
- Defined: `estorides_core/entity_resolution.py:501`
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### _exact_merge (method) `def _exact_merge(records, uf)`
- Defined: `estorides_core/entity_resolution.py:516`
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### _fuzzy_merge (method) `def _fuzzy_merge(self, records, uf)`
- Defined: `estorides_core/entity_resolution.py:528`
...
- Defined: `estorides_core/entity_resolution.py:708`
- Doc: Map canonicals onto persisted ids and record their aliases.
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`

### rank (method) `def rank(rec)`
- Defined: `estorides_core/entity_resolution.py:673`
- Depends on: `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/transliteration.py`
- Imported by: `_test_entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/orchestrator.py`, `tests/test_entity_resolution.py`
...
- Defined: `estorides_core/fusion_store.py:443`
...
- Defined: `estorides_core/fusion_store.py:722`
- Depends on: `estorides_core/config.py`, `estorides_core/entity_resolution.py`, `estorides_core/reliability_scoring.py`
- Imported by: `_test_fusion.py`, `estorides_cli.py`, `estorides_core/orchestrator.py`, `estorides_core/orchestrator.py`, `estorides_web.py`, `tests/test_fusion_analytics.py`, `tests/test_probabilistic_fusion.py`, `tests/test_probabilistic_fusion.py`
...
- Imported by: `_test_passive.py`, `estorides_cli.py`, `estorides_core/discoverer.py`, `estorides_core/discoverer.py`, `estorides_web.py`, `estorides_web.py`, `tests/test_system_app_sources.py`, `tests/test_system_app_sources.py`, `tests/test_system_app_sources.py`
...
- Defined: `estorides_core/orchestrator.py:852`
...
- Defined: `estorides_core/orchestrator.py:865`
- Depends on: `estorides_core/async_client.py`, `estorides_core/cases.py`, `estorides_core/config.py`, `estorides_core/entity_extraction.py`, `estorides_core/entity_resolution.py`, `estorides_core/entity_store.py`, `estorides_core/fusion_store.py`, `estorides_core/graph_kuzu.py`, `estorides_core/intel_resolver.py`, `estorides_core/knowledge_graph.py`, `estorides_core/mitre_attack.py`, `estorides_core/ontology.py`, `estorides_core/pagination.py`, `estorides_core/parsers.py`, `estorides_core/recon_fusion.py`, `estorides_core/relationship_inference.py`, `estorides_core/source_loader.py`, `estorides_core/system_app_sources.py`
- Imported by: `_test_passive.py`, `estorides_cli.py`, `estorides_core/discoverer.py`, `estorides_core/discoverer.py`, `estorides_web.py`, `estorides_web.py`, `tests/test_system_app_sources.py`, `tests/test_system_app_sources.py`, `tests/test_system_app_sources.py`
...
### _reliability_weight (method) `def _reliability_weight(source_name, overrides)`
...
### _reliability_weight_for_letter (method) `def _reliability_weight_for_letter(letter)`
...
- Depends on: `estorides_core/config.py`
- Imported by: `_test_passive.py`, `estorides_core/orchestrator.py`, `tests/test_monitoring.py`, `tests/test_socmint.py`, `tests/test_source_loader.py`, `tests/test_system_app_sources.py`, `tests/test_system_app_sources.py`
...
### _env_int (method) `def _env_int(name, default)`
- Defined: `estorides_core/web_security.py:141`
- Imported by: `estorides_web.py`, `tests/properties/test_csp_safe_styles_properties.py`, `tests/test_auth_gate.py`, `tests/test_auth_gate.py`, `tests/test_csp_safe_styles.py`, `tests/test_csp_safe_styles.py`, `tests/test_security_remediation.py`

### _env_bool (method) `def _env_bool(name, default)`
