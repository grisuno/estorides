...
- Symbols:
  ...
  - `_env_bool` (function, line 60) `def _env_bool(name, default)`
  - `ensure_data_dirs` (function, line 101) `def ensure_data_dirs()`
  - `ensure_reports_dir` (function, line 112) `def ensure_reports_dir()`
  - `_env_tool_allowlist` (function, line 166) `def _env_tool_allowlist()`
  - `contact_level` (function, line 239) `def contact_level(contact)`
  - `effective_proxies` (function, line 265) `def effective_proxies(explicit)`
  - `CacheConfig` (class, line 388) `class CacheConfig`
  - `PivotPolicyConfig` (class, line 401) `class PivotPolicyConfig`
  - `PivotConfig` (class, line 426) `class PivotConfig`
  - `StreamConfig` (class, line 471) `class StreamConfig`
  - `ReconFusionConfig` (class, line 483) `class ReconFusionConfig`
  - `SchemaConfig` (class, line 515) `class SchemaConfig`
  - `WebConfig` (class, line 542) `class WebConfig`
  - `_pivot_weight_map` (method, line 556) `def _pivot_weight_map()`
  - `_csv_frozenset` (method, line 573) `def _csv_frozenset(name, default)`
  - `is_active` (method, line 395) `def is_active(self)`
  - `is_pivotable` (method, line 415) `def is_pivotable(self, entity_type)`
  - `lead_score` (method, line 419) `def lead_score(self, entity_type, depth, parent_score)`
  - `clamp_depth` (method, line 449) `def clamp_depth(self, value)`
  - `clamp_steps` (method, line 453) `def clamp_steps(self, value)`
  - `clamp_entities` (method, line 457) `def clamp_entities(self, value)`
  - `clamp_parallel` (method, line 461) `def clamp_parallel(self, value)`
  - `clamp_deadline` (method, line 465) `def clamp_deadline(self, value)`
  - `__post_init__` (method, line 504) `def __post_init__(self)`
...
- Symbols:
  ...
  - `blocking_keys` (function, line 260) `def blocking_keys(etype, normalized, value)`
  - `MatchScore` (class, line 298) `class MatchScore`
  - `score_pair` (method, line 305) `def score_pair(etype, a_value, b_value, a_norm, b_norm)`
  - `CanonicalEntity` (class, line 344) `class CanonicalEntity`
  - `SameAsLink` (class, line 404) `class SameAsLink`
  - `ResolutionResult` (class, line 422) `class ResolutionResult`
  - `_UnionFind` (class, line 435) `class _UnionFind`
  - `_script_of` (method, line 453) `def _script_of(value)`
  - `EntityResolver` (class, line 457) `class EntityResolver`
  - `resolve_entities` (method, line 730) `def resolve_entities(entities)`
  - `to_dict` (method, line 360) `def to_dict(self)`
  - `to_entity` (method, line 376) `def to_entity(self)`
  - `to_dict` (method, line 412) `def to_dict(self)`
  - `to_dict` (method, line 428) `def to_dict(self)`
  - `__init__` (method, line 438) `def __init__(self, n)`
  - `find` (method, line 441) `def find(self, x)`
  - `union` (method, line 447) `def union(self, a, b)`
  - `__init__` (method, line 472) `def __init__(self)`
  - `resolve` (method, line 485) `def resolve(self, entities)`
  - `_build_records` (method, line 501) `def _build_records(self, entities)`
  - `_exact_merge` (method, line 516) `def _exact_merge(records, uf)`
  - `_fuzzy_merge` (method, line 528) `def _fuzzy_merge(self, records, uf)`
  - `_build_links` (method, line 569) `def _build_links(candidates, uf, root_to_cid)`
  - `_materialise` (method, line 597) `def _materialise(self, records, uf)`
  - `_representative` (method, line 664) `def _representative(members)`
  - `_best_internal_match` (method, line 682) `def _best_internal_match(members)`
  - `_reconcile_with_store` (method, line 708) `def _reconcile_with_store(self, canonicals)`
  - `rank` (method, line 673) `def rank(rec)`
...
- Symbols:
  ...
  - `FusionStore` (class, line 193) `class FusionStore`
  - `open_store` (method, line 758) `def open_store(path)`
  - `__init__` (method, line 201) `def __init__(self, path)`
  - `_init_schema` (method, line 212) `def _init_schema(self)`
  - `_tx` (method, line 218) `def _tx(self)`
  - `_ensure_entity_stub` (method, line 229) `def _ensure_entity_stub(conn, etype, value)`
  - `register_sources` (method, line 249) `def register_sources(self, sources)`
  - `add_observation` (method, line 286) `def add_observation(self, observation)`
  - `fuse_entity` (method, line 327) `def fuse_entity(self, entity)`
  - `fuse_entities` (method, line 430) `def fuse_entities(self, entities)`
  - `fuse_properties` (method, line 443) `def fuse_properties(self, eid, parsed, source)`
  - `fuse_relationship` (method, line 489) `def fuse_relationship(self, src_type, src_value, relation, dst_type, dst_value)`
  - `fuse_graph` (method, line 559) `def fuse_graph(self, kg)`
  - `get_entity` (method, line 595) `def get_entity(self, eid)`
  - `search_entities` (method, line 641) `def search_entities(self, term, etype)`
  - `corroborated_properties` (method, line 684) `def corroborated_properties(self, eid, min_sources)`
  - `list_sources` (method, line 701) `def list_sources(self, limit)`
  - `stats` (method, line 719) `def stats(self)`
  - `close` (method, line 750) `def close(self)`
  - `normalize_value` (method, line 74) `def normalize_value(etype, value)`
  - `_count` (method, line 722) `def _count(table)`
...
- Symbols:
  ...
  - `has_runner` (method, line 333) `def has_runner(self)`
  - `start` (method, line 337) `def start(self)`
  - `stop` (method, line 348) `def stop(self)`
  - `set_runner` (method, line 354) `def set_runner(self, runner)`
  - `set_alerter` (method, line 358) `def set_alerter(self, alerter)`
  - `_loop` (method, line 362) `def _loop(self)`
  - `_execute_watch` (method, line 373) `def _execute_watch(self, watch)`
- Depends on: `estorides_core/config.py`
...
- Symbols:
  ...
  - `_select_sources` (method, line 653) `def _select_sources(self, names)`
  - `_execute_source` (method, line 686) `def _execute_source(self, client, source, query, on_done, on_result)`
  - `_extract_cursor` (method, line 847) `def _extract_cursor(data, cfg)`
  - `_infer_relationships` (method, line 852) `def _infer_relationships(self, observations, query)`
  - `_write_dataset` (method, line 865) `def _write_dataset(self, query, observations, entities, analysis)`
