...
|--------|------|-----------|-----------|
| `_by_value` | function | `_test_entity_resolution.py:40` | `def _by_value(result, value)` |
| `_ent` | function | `_test_entity_resolution.py:36` | `def _ent(etype, value, source)` |
| `check` | function | `_test_entity_resolution.py:27` | `def check(name, cond, detail)` |
| `main` | function | `_test_entity_resolution.py:219` | `def main()` |
| `test_cross_run_stability` | function | `_test_entity_resolution.py:182` | `def test_cross_run_stability()` |
| `test_empty_and_edge_inputs` | function | `_test_entity_resolution.py:211` | `def test_empty_and_edge_inputs()` |
| `test_jaro_winkler` | function | `_test_entity_resolution.py:63` | `def test_jaro_winkler()` |
| `test_normalization` | function | `_test_entity_resolution.py:74` | `def test_normalization()` |
| `test_resolution_merge` | function | `_test_entity_resolution.py:111` | `def test_resolution_merge()` |
| `test_score_pair_policy` | function | `_test_entity_resolution.py:98` | `def test_score_pair_policy()` |
| `test_to_entity_roundtrip` | function | `_test_entity_resolution.py:167` | `def test_to_entity_roundtrip()` |
| `test_transliteration` | function | `_test_entity_resolution.py:47` | `def test_transliteration()` |
| `_fresh_store` | function | `_test_fusion.py:32` | `def _fresh_store()` |
| `check` | function | `_test_fusion.py:24` | `def check(label, cond)` |
| `main` | function | `_test_fusion.py:124` | `def main()` |
| `test_cross_run_dedup_and_provenance` | function | `_test_fusion.py:45` | `def test_cross_run_dedup_and_provenance()` |
| `test_deterministic_identity` | function | `_test_fusion.py:37` | `def test_deterministic_identity()` |
| `test_fail_soft_open` | function | `_test_fusion.py:116` | `def test_fail_soft_open()` |
| `test_min_sources_filter` | function | `_test_fusion.py:76` | `def test_min_sources_filter()` |
| `test_observation_and_source_counters` | function | `_test_fusion.py:97` | `def test_observation_and_source_counters()` |
| `test_property_corroboration_and_conflict` | function | `_test_fusion.py:59` | `def test_property_corroboration_and_conflict()` |
| `test_relationship_fusion` | function | `_test_fusion.py:87` | `def test_relationship_fusion()` |
| `_ok` | function | `_test_hardening.py:25` | `def _ok(name, ok, detail)` |
| `main` | function | `_test_hardening.py:210` | `def main()` |
| `test_case_diff` | function | `_test_hardening.py:113` | `def test_case_diff()` |
| `test_case_diff_endpoints` | function | `_test_hardening.py:137` | `def test_case_diff_endpoints()` |
| `test_case_save_endpoint` | function | `_test_hardening.py:148` | `def test_case_save_endpoint()` |
| `test_console_script_help` | function | `_test_hardening.py:196` | `def test_console_script_help()` |
| `test_cors_allowlist` | function | `_test_hardening.py:62` | `def test_cors_allowlist()` |
| `test_cors_default_off` | function | `_test_hardening.py:53` | `def test_cors_default_off()` |
| `test_debug_killswitch` | function | `_test_hardening.py:87` | `def test_debug_killswitch()` |
| `test_max_body_rejection` | function | `_test_hardening.py:101` | `def test_max_body_rejection()` |
| `test_report_renders` | function | `_test_hardening.py:165` | `def test_report_renders()` |
| `test_report_with_diff` | function | `_test_hardening.py:181` | `def test_report_with_diff()` |
| `test_security_headers` | function | `_test_hardening.py:36` | `def test_security_headers()` |
| `check` | function | `_test_passive.py:20` | `def check(name, cond, detail)` |
| `main` | function | `_test_passive.py:29` | `def main()` |
| `_StubRunner` | class | `_test_people.py:66` | `class _StubRunner` |
| `_types` | function | `_test_people.py:30` | `def _types(payload)` |
| `check` | function | `_test_people.py:21` | `def check(name, cond, detail)` |
| `main` | function | `_test_people.py:37` | `def main()` |
| `run` | method | `_test_people.py:67` | `def run(self, query)` |
| `_enter_and_rotate` | function | `_test_proxy.py:52` | `def _enter_and_rotate()` |
| `_enter_socks` | function | `_test_proxy.py:72` | `def _enter_socks()` |
| `check` | function | `_test_proxy.py:21` | `def check(name, cond, detail)` |
| `main` | function | `_test_proxy.py:30` | `def main()` |
| `check` | function | `_test_scope.py:18` | `def check(name, cond, detail)` |
| `main` | function | `_test_scope.py:27` | `def main()` |
| `main` | function | `_validate.py:17` | `def main()` |
| `_add_opsec_flags` | function | `estorides_cli.py:72` | `def _add_opsec_flags(parser)` |
| `_collect_selectors` | function | `estorides_cli.py:43` | `def _collect_selectors(events, types)` |
| `_on_done` | function | `estorides_cli.py:219` | `def _on_done(source_name, ok, status, elapsed_ms)` |
| `_resolve_proxy` | function | `estorides_cli.py:59` | `def _resolve_proxy(args)` |
| `_run` | function | `estorides_cli.py:531` | `def _run(watch)` |
| `_setup_logging` | function | `estorides_cli.py:36` | `def _setup_logging(verbose)` |
| `_watch_runner_factory` | function | `estorides_cli.py:523` | `def _watch_runner_factory(proxy, passive_only)` |
| `build_parser` | function | `estorides_cli.py:692` | `def build_parser()` |
| `cmd_alerts_channels` | function | `estorides_cli.py:635` | `def cmd_alerts_channels(args)` |
| `cmd_alerts_test` | function | `estorides_cli.py:623` | `def cmd_alerts_test(args)` |
| `cmd_diff` | function | `estorides_cli.py:410` | `def cmd_diff(args)` |
| `cmd_discover` | function | `estorides_cli.py:90` | `def cmd_discover(args)` |
| `cmd_export_misp` | function | `estorides_cli.py:359` | `def cmd_export_misp(args)` |
| `cmd_export_stix` | function | `estorides_cli.py:349` | `def cmd_export_stix(args)` |
| `cmd_fusion` | function | `estorides_cli.py:445` | `def cmd_fusion(args)` |
| `cmd_graph_export` | function | `estorides_cli.py:326` | `def cmd_graph_export(args)` |
| `cmd_report` | function | `estorides_cli.py:369` | `def cmd_report(args)` |
| `cmd_run` | function | `estorides_cli.py:202` | `def cmd_run(args)` |
| `cmd_scheduler_start` | function | `estorides_cli.py:647` | `def cmd_scheduler_start(args)` |
| `cmd_scheduler_status` | function | `estorides_cli.py:667` | `def cmd_scheduler_status(args)` |
| `cmd_scheduler_stop` | function | `estorides_cli.py:657` | `def cmd_scheduler_stop(args)` |
| `cmd_scope` | function | `estorides_cli.py:279` | `def cmd_scope(args)` |
| `cmd_serve` | function | `estorides_cli.py:675` | `def cmd_serve(args)` |
| `cmd_status` | function | `estorides_cli.py:438` | `def cmd_status(_)` |
| `cmd_watch_add` | function | `estorides_cli.py:488` | `def cmd_watch_add(args)` |
| `cmd_watch_disable` | function | `estorides_cli.py:590` | `def cmd_watch_disable(args)` |
| `cmd_watch_enable` | function | `estorides_cli.py:577` | `def cmd_watch_enable(args)` |
| `cmd_watch_history` | function | `estorides_cli.py:602` | `def cmd_watch_history(args)` |
| `cmd_watch_list` | function | `estorides_cli.py:545` | `def cmd_watch_list(args)` |
| `cmd_watch_remove` | function | `estorides_cli.py:565` | `def cmd_watch_remove(args)` |
| `main` | function | `estorides_cli.py:847` | `def main(argv)` |
...
| `AlertDispatcher` | class | `estorides_core/alerter.py:167` | `class AlertDispatcher` |
| `_check_cooldown` | function | `estorides_core/alerter.py:42` | `def _check_cooldown(channel)` |
| `_fmt_time` | method | `estorides_core/alerter.py:284` | `def _fmt_time(ts)` |
| `_http_post` | function | `estorides_core/alerter.py:53` | `def _http_post(url, payload)` |
| `_send_discord` | function | `estorides_core/alerter.py:99` | `def _send_discord(webhook_url, title, body, severity)` |
| `_send_email` | function | `estorides_core/alerter.py:129` | `def _send_email(smtp_host, smtp_port, smtp_user, smtp_pass, from_addr, to_addr, title, body, severity)` |
| `_send_slack` | function | `estorides_core/alerter.py:84` | `def _send_slack(webhook_url, title, body, severity)` |
| `_send_telegram` | function | `estorides_core/alerter.py:114` | `def _send_telegram(bot_token, chat_id, title, body, severity)` |
| `_send_webhook` | function | `estorides_core/alerter.py:150` | `def _send_webhook(webhook_url, title, body, severity)` |
| `available_channels` | method | `estorides_core/alerter.py:260` | `def available_channels(self)` |
| `send` | method | `estorides_core/alerter.py:174` | `def send(self, channel, title, body, severity)` |
| `send_watch_alert` | method | `estorides_core/alerter.py:230` | `def send_watch_alert(self, watch, entity_count, obs_count, new_entities)` |
| `test` | method | `estorides_core/alerter.py:250` | `def test(self, channel)` |
| `AsyncClient` | class | `estorides_core/async_client.py:149` | `class AsyncClient` |
| `CircuitBreaker` | class | `estorides_core/async_client.py:56` | `class CircuitBreaker` |
| `ResponseCache` | class | `estorides_core/async_client.py:78` | `class ResponseCache` |
| `__aenter__` | method | `estorides_core/async_client.py:181` | `def __aenter__(self)` |
| `__aexit__` | method | `estorides_core/async_client.py:233` | `def __aexit__(self)` |
| `__init__` | method | `estorides_core/async_client.py:87` | `def __init__(self, path)` |
| `__init__` | method | `estorides_core/async_client.py:152` | `def __init__(self)` |
| `_init_db` | method | `estorides_core/async_client.py:100` | `def _init_db(self)` |
| `_is_socks` | function | `estorides_core/async_client.py:41` | `def _is_socks(proxy)` |
| `_key` | method | `estorides_core/async_client.py:113` | `def _key(method, url, body)` |
| `_next_http_proxy` | method | `estorides_core/async_client.py:225` | `def _next_http_proxy(self)` |
| `_redact_proxy` | function | `estorides_core/async_client.py:46` | `def _redact_proxy(proxy)` |
| `allow` | method | `estorides_core/async_client.py:61` | `def allow(self, host)` |
| `fetch` | method | `estorides_core/async_client.py:245` | `def fetch(self, method, url)` |
| `get` | method | `estorides_core/async_client.py:122` | `def get(self, method, url, body)` |
| `record_failure` | method | `estorides_core/async_client.py:71` | `def record_failure(self, host)` |
| `record_success` | method | `estorides_core/async_client.py:67` | `def record_success(self, host)` |
| `session` | method | `estorides_core/async_client.py:239` | `def session(self)` |
| `set` | method | `estorides_core/async_client.py:138` | `def set(self, method, url, body, value)` |
| `sync_fetch` | method | `estorides_core/async_client.py:375` | `def sync_fetch(method, url)` |
| `AuditEvent` | class | `estorides_core/audit.py:55` | `class AuditEvent` |
| `AuditLog` | class | `estorides_core/audit.py:72` | `class AuditLog` |
| `RateLimiter` | class | `estorides_core/audit.py:180` | `class RateLimiter` |
...
| `_maybe_rotate_locked` | method | `estorides_core/audit.py:115` | `def _maybe_rotate_locked(self)` |
| `allow` | method | `estorides_core/audit.py:214` | `def allow(self, key)` |
...
| `CaseStore` | class | `estorides_core/cases.py:112` | `class CaseStore` |
| `__init__` | method | `estorides_core/cases.py:121` | `def __init__(self, path)` |
| `_init_schema` | method | `estorides_core/cases.py:135` | `def _init_schema(self)` |
| `_per_type` | method | `estorides_core/cases.py:332` | `def _per_type(pairs)` |
| `_row_to_case` | method | `estorides_core/cases.py:424` | `def _row_to_case(self, row)` |
| `_safe_json` | method | `estorides_core/cases.py:442` | `def _safe_json(text)` |
| `_serialise` | method | `estorides_core/cases.py:338` | `def _serialise(pairs)` |
| `_tx` | method | `estorides_core/cases.py:141` | `def _tx(self)` |
| `add_entities` | method | `estorides_core/cases.py:202` | `def add_entities(self, case_id, entities)` |
| `add_observation` | method | `estorides_core/cases.py:168` | `def add_observation(self, case_id, observation)` |
| `close` | method | `estorides_core/cases.py:450` | `def close(self)` |
| `create_case` | method | `estorides_core/cases.py:152` | `def create_case(self, query, query_type, notes)` |
| `delete_case` | method | `estorides_core/cases.py:255` | `def delete_case(self, case_id)` |
| `diff_entities` | method | `estorides_core/cases.py:311` | `def diff_entities(self, case_a, case_b)` |
| `finalise` | method | `estorides_core/cases.py:225` | `def finalise(self, case_id, analysis, kg_path, mitre, source_count, obs_count, entity_count, status)` |
| `get_case` | method | `estorides_core/cases.py:260` | `def get_case(self, case_id)` |
| `list_entities` | method | `estorides_core/cases.py:296` | `def list_entities(self, case_id)` |
| `list_observations` | method | `estorides_core/cases.py:273` | `def list_observations(self, case_id)` |
| `search_by_entity` | method | `estorides_core/cases.py:388` | `def search_by_entity(self, ent_type, value, limit)` |
| `search_cases` | method | `estorides_core/cases.py:358` | `def search_cases(self, query_substring, limit, query_type)` |
| `stats` | method | `estorides_core/cases.py:416` | `def stats(self)` |
| `Change` | class | `estorides_core/change_detection.py:134` | `class Change` |
| `ChangeConfig` | class | `estorides_core/change_detection.py:104` | `class ChangeConfig` |
| `ChangeReport` | class | `estorides_core/change_detection.py:168` | `class ChangeReport` |
| `ChangeSummary` | class | `estorides_core/change_detection.py:151` | `class ChangeSummary` |
| `Diff` | class | `estorides_core/change_detection.py:125` | `class Diff` |
| `Edge` | class | `estorides_core/change_detection.py:58` | `class Edge` |
| `Snapshot` | class | `estorides_core/change_detection.py:96` | `class Snapshot` |
| `SnapshotEntity` | class | `estorides_core/change_detection.py:66` | `class SnapshotEntity` |
| `__post_init__` | method | `estorides_core/change_detection.py:84` | `def __post_init__(self)` |
| `__post_init__` | method | `estorides_core/change_detection.py:115` | `def __post_init__(self)` |
| `_below_min_reliability` | method | `estorides_core/change_detection.py:291` | `def _below_min_reliability(source, min_reliability)` |
| `_change_id` | method | `estorides_core/change_detection.py:183` | `def _change_id(kind, entity_id, diff_signature)` |
| `_edge_set` | method | `estorides_core/change_detection.py:242` | `def _edge_set(edges)` |
| `_filter_sources_by_reliability` | method | `estorides_core/change_detection.py:210` | `def _filter_sources_by_reliability(sources, min_reliability)` |
| `_make_change` | method | `estorides_core/change_detection.py:258` | `def _make_change(kind, entity_id, entity_type, entity_value, sig)` |
| `_property_diff` | method | `estorides_core/change_detection.py:223` | `def _property_diff(before, after)` |
| `_reliability_floor` | method | `estorides_core/change_detection.py:205` | `def _reliability_floor(letter)` |
| `_reliability_weight` | method | `estorides_core/change_detection.py:188` | `def _reliability_weight(name)` |
| `_truncate_key` | method | `estorides_core/change_detection.py:176` | `def _truncate_key(key)` |
| `_union_sources` | method | `estorides_core/change_detection.py:246` | `def _union_sources(a, b)` |
| `detect_changes` | method | `estorides_core/change_detection.py:301` | `def detect_changes(snapshot_before, snapshot_after)` |
...
| `CacheConfig` | class | `estorides_core/config.py:375` | `class CacheConfig` |
| `PivotConfig` | class | `estorides_core/config.py:413` | `class PivotConfig` |
| `PivotPolicyConfig` | class | `estorides_core/config.py:388` | `class PivotPolicyConfig` |
| `ReconFusionConfig` | class | `estorides_core/config.py:470` | `class ReconFusionConfig` |
| `SchemaConfig` | class | `estorides_core/config.py:502` | `class SchemaConfig` |
| `StreamConfig` | class | `estorides_core/config.py:458` | `class StreamConfig` |
| `WebConfig` | class | `estorides_core/config.py:529` | `class WebConfig` |
| `__post_init__` | method | `estorides_core/config.py:491` | `def __post_init__(self)` |
| `_csv_frozenset` | method | `estorides_core/config.py:560` | `def _csv_frozenset(name, default)` |
| `_env_bool` | function | `estorides_core/config.py:56` | `def _env_bool(name, default)` |
| `_env_float` | function | `estorides_core/config.py:44` | `def _env_float(name, default)` |
| `_env_int` | function | `estorides_core/config.py:32` | `def _env_int(name, default)` |
| `_env_tool_allowlist` | function | `estorides_core/config.py:151` | `def _env_tool_allowlist()` |
| `_pivot_weight_map` | method | `estorides_core/config.py:543` | `def _pivot_weight_map()` |
| `clamp_deadline` | method | `estorides_core/config.py:452` | `def clamp_deadline(self, value)` |
| `clamp_depth` | method | `estorides_core/config.py:436` | `def clamp_depth(self, value)` |
| `clamp_entities` | method | `estorides_core/config.py:444` | `def clamp_entities(self, value)` |
| `clamp_parallel` | method | `estorides_core/config.py:448` | `def clamp_parallel(self, value)` |
| `clamp_steps` | method | `estorides_core/config.py:440` | `def clamp_steps(self, value)` |
| `contact_level` | function | `estorides_core/config.py:224` | `def contact_level(contact)` |
| `effective_proxies` | function | `estorides_core/config.py:250` | `def effective_proxies(explicit)` |
| `ensure_data_dirs` | function | `estorides_core/config.py:86` | `def ensure_data_dirs()` |
| `ensure_reports_dir` | function | `estorides_core/config.py:97` | `def ensure_reports_dir()` |
| `is_active` | method | `estorides_core/config.py:382` | `def is_active(self)` |
| `is_pivotable` | method | `estorides_core/config.py:402` | `def is_pivotable(self, entity_type)` |
| `lead_score` | method | `estorides_core/config.py:406` | `def lead_score(self, entity_type, depth, parent_score)` |
| `DiscoverJob` | class | `estorides_core/discoverer.py:50` | `class DiscoverJob` |
| `_DiscoverJobSink` | class | `estorides_core/discoverer.py:95` | `class _DiscoverJobSink` |
| `__init__` | method | `estorides_core/discoverer.py:103` | `def __init__(self, job)` |
| `_new_job_id` | method | `estorides_core/discoverer.py:189` | `def _new_job_id()` |
...
| `_run_discoverer` | method | `estorides_core/discoverer.py:319` | `def _run_discoverer(job)` |
| `create_discover_job` | method | `estorides_core/discoverer.py:194` | `def create_discover_job(seed_type, seed_value)` |
| `emit` | method | `estorides_core/discoverer.py:106` | `def emit(self, event)` |
| `list_jobs` | method | `estorides_core/discoverer.py:349` | `def list_jobs(limit)` |
| `push_event` | method | `estorides_core/discoverer.py:84` | `def push_event(self, ev)` |
| `should_stop` | method | `estorides_core/discoverer.py:81` | `def should_stop(self)` |
| `start_discover` | method | `estorides_core/discoverer.py:252` | `def start_discover(seed_type, seed_value)` |
| `start_discover_threadsafe` | method | `estorides_core/discoverer.py:285` | `def start_discover_threadsafe(loop, seed_type, seed_value)` |
...
| `_classify_keyed_value` | method | `estorides_core/entity_extraction.py:261` | `def _classify_keyed_value(key, value)` |
| `_clean_scalar` | method | `estorides_core/entity_extraction.py:233` | `def _clean_scalar(value)` |
| `_context` | method | `estorides_core/entity_extraction.py:97` | `def _context(text, start, end, window)` |
| `_fuzzy_cluster` | method | `estorides_core/entity_extraction.py:431` | `def _fuzzy_cluster(entities)` |
| `_ip_in_textual_context` | method | `estorides_core/entity_extraction.py:155` | `def _ip_in_textual_context(text, idx)` |
| `_is_valid_domain` | method | `estorides_core/entity_extraction.py:84` | `def _is_valid_domain(candidate)` |
| `_looks_like_person` | method | `estorides_core/entity_extraction.py:243` | `def _looks_like_person(value)` |
| `_looks_like_username` | method | `estorides_core/entity_extraction.py:254` | `def _looks_like_username(value)` |
| `detect_query_type` | method | `estorides_core/entity_extraction.py:63` | `def detect_query_type(query)` |
| `extract_from_json` | method | `estorides_core/entity_extraction.py:165` | `def extract_from_json(payload, source)` |
| `extract_from_text` | method | `estorides_core/entity_extraction.py:103` | `def extract_from_text(text, source)` |
| `extract_structured` | method | `estorides_core/entity_extraction.py:285` | `def extract_structured(payload, source)` |
| `find` | method | `estorides_core/entity_extraction.py:452` | `def find(x)` |
| `merge` | method | `estorides_core/entity_extraction.py:337` | `def merge()` |
| `norm` | method | `estorides_core/entity_extraction.py:463` | `def norm(v)` |
| `to_dict` | method | `estorides_core/entity_extraction.py:34` | `def to_dict(self)` |
| `union` | method | `estorides_core/entity_extraction.py:458` | `def union(a, b)` |
| `visit` | method | `estorides_core/entity_extraction.py:299` | `def visit(node, key)` |
| `CanonicalEntity` | class | `estorides_core/entity_resolution.py:342` | `class CanonicalEntity` |
| `EntityResolver` | class | `estorides_core/entity_resolution.py:455` | `class EntityResolver` |
| `MatchScore` | class | `estorides_core/entity_resolution.py:296` | `class MatchScore` |
| `ResolutionResult` | class | `estorides_core/entity_resolution.py:420` | `class ResolutionResult` |
| `SameAsLink` | class | `estorides_core/entity_resolution.py:402` | `class SameAsLink` |
| `_UnionFind` | class | `estorides_core/entity_resolution.py:433` | `class _UnionFind` |
| `__init__` | method | `estorides_core/entity_resolution.py:436` | `def __init__(self, n)` |
| `__init__` | method | `estorides_core/entity_resolution.py:470` | `def __init__(self)` |
| `_best_internal_match` | method | `estorides_core/entity_resolution.py:680` | `def _best_internal_match(members)` |
| `_build_links` | method | `estorides_core/entity_resolution.py:567` | `def _build_links(candidates, uf, root_to_cid)` |
| `_build_records` | method | `estorides_core/entity_resolution.py:499` | `def _build_records(self, entities)` |
| `_exact_merge` | method | `estorides_core/entity_resolution.py:514` | `def _exact_merge(records, uf)` |
| `_fuzzy_merge` | method | `estorides_core/entity_resolution.py:526` | `def _fuzzy_merge(self, records, uf)` |
| `_materialise` | method | `estorides_core/entity_resolution.py:595` | `def _materialise(self, records, uf)` |
| `_normalize_domain` | function | `estorides_core/entity_resolution.py:178` | `def _normalize_domain(value)` |
| `_normalize_name` | function | `estorides_core/entity_resolution.py:187` | `def _normalize_name(value)` |
| `_reconcile_with_store` | method | `estorides_core/entity_resolution.py:706` | `def _reconcile_with_store(self, canonicals)` |
| `_representative` | method | `estorides_core/entity_resolution.py:662` | `def _representative(members)` |
| `_script_of` | method | `estorides_core/entity_resolution.py:451` | `def _script_of(value)` |
| `_soundex` | function | `estorides_core/entity_resolution.py:146` | `def _soundex(token)` |
| `blocking_keys` | function | `estorides_core/entity_resolution.py:258` | `def blocking_keys(etype, normalized, value)` |
| `canonical_id` | function | `estorides_core/entity_resolution.py:246` | `def canonical_id(etype, normalized)` |
| `find` | method | `estorides_core/entity_resolution.py:439` | `def find(self, x)` |
| `jaro` | function | `estorides_core/entity_resolution.py:83` | `def jaro(s1, s2)` |
| `jaro_winkler` | function | `estorides_core/entity_resolution.py:126` | `def jaro_winkler(s1, s2, prefix_weight)` |
| `normalize_value` | function | `estorides_core/entity_resolution.py:206` | `def normalize_value(etype, value)` |
| `rank` | method | `estorides_core/entity_resolution.py:671` | `def rank(rec)` |
| `resolve` | method | `estorides_core/entity_resolution.py:483` | `def resolve(self, entities)` |
| `resolve_entities` | method | `estorides_core/entity_resolution.py:728` | `def resolve_entities(entities)` |
| `score_pair` | method | `estorides_core/entity_resolution.py:303` | `def score_pair(etype, a_value, b_value, a_norm, b_norm)` |
| `to_dict` | method | `estorides_core/entity_resolution.py:358` | `def to_dict(self)` |
| `to_dict` | method | `estorides_core/entity_resolution.py:410` | `def to_dict(self)` |
| `to_dict` | method | `estorides_core/entity_resolution.py:426` | `def to_dict(self)` |
| `to_entity` | method | `estorides_core/entity_resolution.py:374` | `def to_entity(self)` |
| `union` | method | `estorides_core/entity_resolution.py:445` | `def union(self, a, b)` |
| `EntityStore` | class | `estorides_core/entity_store.py:62` | `class EntityStore` |
| `__init__` | method | `estorides_core/entity_store.py:65` | `def __init__(self, path)` |
| `_init_schema` | method | `estorides_core/entity_store.py:75` | `def _init_schema(self)` |
| `_tx` | method | `estorides_core/entity_store.py:81` | `def _tx(self)` |
| `close` | method | `estorides_core/entity_store.py:179` | `def close(self)` |
| `lookup` | method | `estorides_core/entity_store.py:91` | `def lookup(self, etype, normalized, aliases)` |
| `open_store` | method | `estorides_core/entity_store.py:184` | `def open_store(path)` |
| `stats` | method | `estorides_core/entity_store.py:168` | `def stats(self)` |
| `upsert` | method | `estorides_core/entity_store.py:129` | `def upsert(self, entity)` |
| `EarthquakesFeed` | class | `estorides_core/feeds.py:148` | `class EarthquakesFeed(Feed)` |
| `Feed` | class | `estorides_core/feeds.py:74` | `class Feed(ABC)` |
| `FeedPoint` | class | `estorides_core/feeds.py:54` | `class FeedPoint` |
| `FiresFeed` | class | `estorides_core/feeds.py:190` | `class FiresFeed(Feed)` |
| `NewsFeed` | class | `estorides_core/feeds.py:251` | `class NewsFeed(Feed)` |
| `__init__` | method | `estorides_core/feeds.py:82` | `def __init__(self)` |
| `_fetch` | method | `estorides_core/feeds.py:87` | `def _fetch(self)` |
| `_fetch` | method | `estorides_core/feeds.py:156` | `def _fetch(self)` |
| `_fetch` | method | `estorides_core/feeds.py:209` | `def _fetch(self)` |
| `_fetch` | method | `estorides_core/feeds.py:271` | `def _fetch(self)` |
| `fetch` | method | `estorides_core/feeds.py:90` | `def fetch(self)` |
| `fetch_all` | method | `estorides_core/feeds.py:325` | `def fetch_all(bbox, use_cache)` |
| `get_feed` | method | `estorides_core/feeds.py:321` | `def get_feed(name)` |
| `list_feeds` | method | `estorides_core/feeds.py:313` | `def list_feeds()` |
| `point` | method | `estorides_core/feeds.py:135` | `def point(self, record)` |
| `to_dict` | method | `estorides_core/feeds.py:69` | `def to_dict(self)` |
| `FusionAnalytics` | class | `estorides_core/fusion_analytics.py:31` | `class FusionAnalytics` |
| `__init__` | method | `estorides_core/fusion_analytics.py:40` | `def __init__(self, store)` |
| `_deduplicate_relationships` | method | `estorides_core/fusion_analytics.py:540` | `def _deduplicate_relationships(rels)` |
| `_intel_level` | method | `estorides_core/fusion_analytics.py:532` | `def _intel_level(source_count, sources)` |
| `_resolve_entity_type` | method | `estorides_core/fusion_analytics.py:520` | `def _resolve_entity_type(self, eid)` |
| `_resolve_entity_value` | method | `estorides_core/fusion_analytics.py:509` | `def _resolve_entity_value(self, eid)` |
...
| `FusionStore` | class | `estorides_core/fusion_store.py:191` | `class FusionStore` |
| `__init__` | method | `estorides_core/fusion_store.py:199` | `def __init__(self, path)` |
| `_count` | method | `estorides_core/fusion_store.py:720` | `def _count(table)` |
| `_ensure_entity_stub` | method | `estorides_core/fusion_store.py:227` | `def _ensure_entity_stub(conn, etype, value)` |
| `_init_schema` | method | `estorides_core/fusion_store.py:210` | `def _init_schema(self)` |
| `_tx` | method | `estorides_core/fusion_store.py:216` | `def _tx(self)` |
| `add_observation` | method | `estorides_core/fusion_store.py:284` | `def add_observation(self, observation)` |
| `close` | method | `estorides_core/fusion_store.py:745` | `def close(self)` |
| `corroborated_properties` | method | `estorides_core/fusion_store.py:682` | `def corroborated_properties(self, eid, min_sources)` |
| `entity_id` | function | `estorides_core/fusion_store.py:178` | `def entity_id(etype, value, normalized)` |
| `fuse_entities` | method | `estorides_core/fusion_store.py:428` | `def fuse_entities(self, entities)` |
| `fuse_entity` | method | `estorides_core/fusion_store.py:325` | `def fuse_entity(self, entity)` |
| `fuse_graph` | method | `estorides_core/fusion_store.py:557` | `def fuse_graph(self, kg)` |
| `fuse_properties` | method | `estorides_core/fusion_store.py:441` | `def fuse_properties(self, eid, parsed, source)` |
| `fuse_relationship` | method | `estorides_core/fusion_store.py:487` | `def fuse_relationship(self, src_type, src_value, relation, dst_type, dst_value)` |
| `get_entity` | method | `estorides_core/fusion_store.py:593` | `def get_entity(self, eid)` |
| `list_sources` | method | `estorides_core/fusion_store.py:699` | `def list_sources(self, limit)` |
| `normalize_value` | method | `estorides_core/fusion_store.py:74` | `def normalize_value(etype, value)` |
| `open_store` | method | `estorides_core/fusion_store.py:753` | `def open_store(path)` |
| `register_sources` | method | `estorides_core/fusion_store.py:247` | `def register_sources(self, sources)` |
| `search_entities` | method | `estorides_core/fusion_store.py:639` | `def search_entities(self, term, etype)` |
| `stats` | method | `estorides_core/fusion_store.py:717` | `def stats(self)` |
...
| `_label_for` | function | `estorides_core/graph_kuzu.py:124` | `def _label_for(ent_type)` |
| `_node_id` | function | `estorides_core/graph_kuzu.py:133` | `def _node_id(type_, value)` |
| `close` | method | `estorides_core/graph_kuzu.py:436` | `def close(self)` |
| `cypher` | method | `estorides_core/graph_kuzu.py:379` | `def cypher(self, query, params)` |
| `neighbors` | method | `estorides_core/graph_kuzu.py:346` | `def neighbors(self, node_id, hops, relation, limit)` |
...
| `EntityRef` | class | `estorides_core/hypothesis_engine.py:54` | `class EntityRef` |
| `Evidence` | class | `estorides_core/hypothesis_engine.py:62` | `class Evidence` |
| `Hypothesis` | class | `estorides_core/hypothesis_engine.py:73` | `class Hypothesis` |
| `HypothesisGenerator` | class | `estorides_core/hypothesis_engine.py:207` | `class HypothesisGenerator(Protocol)` |
| `__call__` | method | `estorides_core/hypothesis_engine.py:210` | `def __call__(self, observations, entities)` |
| `_asn_shared_infra` | method | `estorides_core/hypothesis_engine.py:533` | `def _asn_shared_infra(observations, entities)` |
| `_clip_claim` | method | `estorides_core/hypothesis_engine.py:198` | `def _clip_claim(template)` |
| `_confidence` | method | `estorides_core/hypothesis_engine.py:177` | `def _confidence(supporting, contradicting)` |
| `_domain_belongsto_actor` | method | `estorides_core/hypothesis_engine.py:217` | `def _domain_belongsto_actor(observations, entities)` |
| `_domains_in_obs` | method | `estorides_core/hypothesis_engine.py:309` | `def _domains_in_obs(obs)` |
| `_email_aliases_person` | method | `estorides_core/hypothesis_engine.py:342` | `def _email_aliases_person(observations, entities)` |
| `_entity_lookup` | method | `estorides_core/hypothesis_engine.py:124` | `def _entity_lookup(entities)` |
| `_extract_asn` | method | `estorides_core/hypothesis_engine.py:597` | `def _extract_asn(parsed)` |
| `_extract_email` | method | `estorides_core/hypothesis_engine.py:402` | `def _extract_email(parsed)` |
| `_extract_ips` | method | `estorides_core/hypothesis_engine.py:505` | `def _extract_ips(parsed)` |
| `_extract_person_name` | method | `estorides_core/hypothesis_engine.py:413` | `def _extract_person_name(parsed)` |
| `_hypothesis_id` | method | `estorides_core/hypothesis_engine.py:145` | `def _hypothesis_id(htype, entity_refs, supporting)` |
| `_ip_shared_infra` | method | `estorides_core/hypothesis_engine.py:424` | `def _ip_shared_infra(observations, entities)` |
| `_is_mapping` | method | `estorides_core/hypothesis_engine.py:120` | `def _is_mapping(value)` |
| `_looks_like_ipv4` | method | `estorides_core/hypothesis_engine.py:520` | `def _looks_like_ipv4(s)` |
| `_score` | method | `estorides_core/hypothesis_engine.py:163` | `def _score(supporting, contradicting)` |
| `_truncate` | method | `estorides_core/hypothesis_engine.py:110` | `def _truncate(value)` |
| `generate_hypotheses` | method | `estorides_core/hypothesis_engine.py:622` | `def generate_hypotheses(observations, entities, kg)` |
| `EntityResolver` | class | `estorides_core/intel_resolver.py:156` | `class EntityResolver` |
...
| `_escape_sparql` | method | `estorides_core/intel_resolver.py:801` | `def _escape_sparql(s)` |
| `_is_valid_ipv4` | method | `estorides_core/intel_resolver.py:793` | `def _is_valid_ipv4(s)` |
| `_norm` | method | `estorides_core/intel_resolver.py:789` | `def _norm(s)` |
...
| `_resolve_crypto` | method | `estorides_core/intel_resolver.py:756` | `def _resolve_crypto(self, addr, kind)` |
...
| `_resolve_eth` | method | `estorides_core/intel_resolver.py:753` | `def _resolve_eth(self, addr)` |
| `_resolve_file` | method | `estorides_core/intel_resolver.py:473` | `def _resolve_file(self, file_hash)` |
...
| `_run_sparql` | function | `estorides_core/intel_resolver.py:90` | `def _run_sparql(query)` |
| `_val` | function | `estorides_core/intel_resolver.py:111` | `def _val(row, key)` |
| `_vt_add_relationship` | method | `estorides_core/intel_resolver.py:245` | `def _vt_add_relationship(self, path)` |
| `_vt_flag_malicious` | method | `estorides_core/intel_resolver.py:290` | `def _vt_flag_malicious(self, path, node, sources)` |
| `_vt_get` | method | `estorides_core/intel_resolver.py:214` | `def _vt_get(self, path, limit)` |
...
| `BoundedJobRegistry` | class | `estorides_core/job_registry.py:40` | `class BoundedJobRegistry` |
| `__init__` | method | `estorides_core/job_registry.py:49` | `def __init__(self)` |
| `__len__` | method | `estorides_core/job_registry.py:109` | `def __len__(self)` |
| `_evict_expired_locked` | method | `estorides_core/job_registry.py:119` | `def _evict_expired_locked(self, now)` |
| `evict_expired` | method | `estorides_core/job_registry.py:113` | `def evict_expired(self)` |
| `get` | method | `estorides_core/job_registry.py:80` | `def get(self, key)` |
| `keys` | method | `estorides_core/job_registry.py:101` | `def keys(self)` |
| `pop` | method | `estorides_core/job_registry.py:95` | `def pop(self, key)` |
| `register` | method | `estorides_core/job_registry.py:60` | `def register(self, key, value)` |
| `values` | method | `estorides_core/job_registry.py:105` | `def values(self)` |
...
| `_node_sources` | function | `estorides_core/knowledge_graph.py:73` | `def _node_sources(node)` |
| `_source_node` | method | `estorides_core/knowledge_graph.py:341` | `def _source_node(self, source)` |
| `add_entity` | method | `estorides_core/knowledge_graph.py:97` | `def add_entity(self, entity)` |
| `add_observation` | method | `estorides_core/knowledge_graph.py:127` | `def add_observation(self, source, entities)` |
...
| `communities` | method | `estorides_core/knowledge_graph.py:235` | `def communities(self, nodes)` |
...
| `intel_level` | method | `estorides_core/knowledge_graph.py:266` | `def intel_level(self, node_id, bridge_nodes)` |
...
| `WatchScheduler` | class | `estorides_core/monitoring.py:309` | `class WatchScheduler` |
| `WatchStore` | class | `estorides_core/monitoring.py:155` | `class WatchStore` |
| `WatchTarget` | class | `estorides_core/monitoring.py:91` | `class WatchTarget` |
| `__init__` | method | `estorides_core/monitoring.py:158` | `def __init__(self, path)` |
| `__init__` | method | `estorides_core/monitoring.py:316` | `def __init__(self, store, runner, alerter)` |
| `__post_init__` | method | `estorides_core/monitoring.py:106` | `def __post_init__(self)` |
| `_execute_watch` | method | `estorides_core/monitoring.py:368` | `def _execute_watch(self, watch)` |
| `_init_schema` | method | `estorides_core/monitoring.py:169` | `def _init_schema(self)` |
| `_loop` | method | `estorides_core/monitoring.py:357` | `def _loop(self)` |
| `_tx` | method | `estorides_core/monitoring.py:175` | `def _tx(self)` |
| `close` | method | `estorides_core/monitoring.py:299` | `def close(self)` |
| `create_watch` | method | `estorides_core/monitoring.py:185` | `def create_watch(self, watch)` |
| `delete_watch` | method | `estorides_core/monitoring.py:222` | `def delete_watch(self, watch_id)` |
| `due_watches` | method | `estorides_core/monitoring.py:236` | `def due_watches(self, now)` |
...
| `get_watch` | method | `estorides_core/monitoring.py:200` | `def get_watch(self, watch_id)` |
| `history` | method | `estorides_core/monitoring.py:272` | `def history(self, watch_id, limit)` |
| `list_watches` | method | `estorides_core/monitoring.py:226` | `def list_watches(self, enabled_only)` |
| `record_run_complete` | method | `estorides_core/monitoring.py:259` | `def record_run_complete(self, history_id, status, entity_count, obs_count, error, alert_sent)` |
| `record_run_start` | method | `estorides_core/monitoring.py:249` | `def record_run_start(self, watch_id)` |
| `running` | method | `estorides_core/monitoring.py:329` | `def running(self)` |
| `set_alerter` | method | `estorides_core/monitoring.py:353` | `def set_alerter(self, alerter)` |
| `set_runner` | method | `estorides_core/monitoring.py:349` | `def set_runner(self, runner)` |
| `start` | method | `estorides_core/monitoring.py:332` | `def start(self)` |
| `stats` | method | `estorides_core/monitoring.py:289` | `def stats(self)` |
| `stop` | method | `estorides_core/monitoring.py:343` | `def stop(self)` |
| `to_dict` | method | `estorides_core/monitoring.py:110` | `def to_dict(self)` |
| `update_watch` | method | `estorides_core/monitoring.py:209` | `def update_watch(self, watch)` |
...
| `Orchestrator` | class | `estorides_core/orchestrator.py:143` | `class Orchestrator` |
| `__init__` | method | `estorides_core/orchestrator.py:144` | `def __init__(self)` |
| `_domain_from_query` | function | `estorides_core/orchestrator.py:133` | `def _domain_from_query(q)` |
| `_execute_source` | method | `estorides_core/orchestrator.py:682` | `def _execute_source(self, client, source, query, on_done, on_result)` |
| `_extract_cursor` | method | `estorides_core/orchestrator.py:843` | `def _extract_cursor(data, cfg)` |
| `_infer_relationships` | method | `estorides_core/orchestrator.py:848` | `def _infer_relationships(self, observations, query)` |
| `_resolve_auth` | function | `estorides_core/orchestrator.py:123` | `def _resolve_auth(source)` |
| `_safe_format` | function | `estorides_core/orchestrator.py:111` | `def _safe_format(template)` |
| `_select_sources` | method | `estorides_core/orchestrator.py:649` | `def _select_sources(self, names)` |
| `_write_dataset` | method | `estorides_core/orchestrator.py:861` | `def _write_dataset(self, query, observations, entities, analysis)` |
| `pending_system_app_tasks` | function | `estorides_core/orchestrator.py:52` | `def pending_system_app_tasks()` |
| `repl` | method | `estorides_core/orchestrator.py:118` | `def repl(m)` |
| `run` | method | `estorides_core/orchestrator.py:159` | `def run(self, query)` |
...
| `_first` | function | `estorides_core/parsers.py:45` | `def _first(obj)` |
| `_flat` | function | `estorides_core/parsers.py:31` | `def _flat(obj)` |
| `_normalise_discord_server` | function | `estorides_core/parsers.py:1078` | `def _normalise_discord_server(raw)` |
| `_vt_stats` | function | `estorides_core/parsers.py:284` | `def _vt_stats(attrs)` |
| `deco` | function | `estorides_core/parsers.py:1196` | `def deco(func)` |
| `get_parser` | function | `estorides_core/parsers.py:1175` | `def get_parser(name)` |
| `list_parsers` | function | `estorides_core/parsers.py:1204` | `def list_parsers()` |
| `parse_abuseipdb` | function | `estorides_core/parsers.py:268` | `def parse_abuseipdb(payload)` |
| `parse_arxiv` | function | `estorides_core/parsers.py:619` | `def parse_arxiv(payload)` |
| `parse_blockchain_btc` | function | `estorides_core/parsers.py:686` | `def parse_blockchain_btc(payload)` |
| `parse_blockstream` | function | `estorides_core/parsers.py:702` | `def parse_blockstream(payload)` |
| `parse_crossref` | function | `estorides_core/parsers.py:599` | `def parse_crossref(payload)` |
| `parse_crtsh_json` | function | `estorides_core/parsers.py:78` | `def parse_crtsh_json(payload)` |
| `parse_dev_to` | function | `estorides_core/parsers.py:885` | `def parse_dev_to(payload)` |
| `parse_discord_discovery` | function | `estorides_core/parsers.py:1058` | `def parse_discord_discovery(payload)` |
| `parse_dns_json` | function | `estorides_core/parsers.py:63` | `def parse_dns_json(payload)` |
| `parse_ethplorer` | function | `estorides_core/parsers.py:718` | `def parse_ethplorer(payload)` |
| `parse_github_advisories` | function | `estorides_core/parsers.py:662` | `def parse_github_advisories(payload)` |
| `parse_github_search` | function | `estorides_core/parsers.py:774` | `def parse_github_search(payload)` |
| `parse_github_user` | function | `estorides_core/parsers.py:754` | `def parse_github_user(payload)` |
| `parse_greynoise` | function | `estorides_core/parsers.py:235` | `def parse_greynoise(payload)` |
| `parse_hackernews` | function | `estorides_core/parsers.py:859` | `def parse_hackernews(payload)` |
| `parse_hibp_breach` | function | `estorides_core/parsers.py:503` | `def parse_hibp_breach(payload)` |
| `parse_hibp_paste` | function | `estorides_core/parsers.py:521` | `def parse_hibp_paste(payload)` |
| `parse_http_headers` | function | `estorides_core/parsers.py:919` | `def parse_http_headers(payload)` |
| `parse_ipapi` | function | `estorides_core/parsers.py:171` | `def parse_ipapi(payload)` |
| `parse_ipapi_co` | function | `estorides_core/parsers.py:212` | `def parse_ipapi_co(payload)` |
| `parse_ipinfo` | function | `estorides_core/parsers.py:197` | `def parse_ipinfo(payload)` |
| `parse_ipwhois` | function | `estorides_core/parsers.py:250` | `def parse_ipwhois(payload)` |
| `parse_keybase` | function | `estorides_core/parsers.py:835` | `def parse_keybase(payload)` |
| `parse_malwarebazaar` | function | `estorides_core/parsers.py:470` | `def parse_malwarebazaar(payload)` |
| `parse_mastodon` | function | `estorides_core/parsers.py:819` | `def parse_mastodon(payload)` |
| `parse_microlink` | function | `estorides_core/parsers.py:734` | `def parse_microlink(payload)` |
| `parse_nominatim` | function | `estorides_core/parsers.py:381` | `def parse_nominatim(payload)` |
| `parse_nvd_cve` | function | `estorides_core/parsers.py:640` | `def parse_nvd_cve(payload)` |
| `parse_openalex` | function | `estorides_core/parsers.py:579` | `def parse_openalex(payload)` |
| `parse_otx` | function | `estorides_core/parsers.py:479` | `def parse_otx(payload)` |
| `parse_phonebook` | function | `estorides_core/parsers.py:537` | `def parse_phonebook(payload)` |
| `parse_raw_text` | function | `estorides_core/parsers.py:911` | `def parse_raw_text(payload)` |
| `parse_rdap` | function | `estorides_core/parsers.py:96` | `def parse_rdap(payload)` |
| `parse_reddit` | function | `estorides_core/parsers.py:789` | `def parse_reddit(payload)` |
| `parse_reddit_search` | function | `estorides_core/parsers.py:871` | `def parse_reddit_search(payload)` |
| `parse_ripe_stat` | function | `estorides_core/parsers.py:370` | `def parse_ripe_stat(payload)` |
| `parse_shodan_internetdb` | function | `estorides_core/parsers.py:221` | `def parse_shodan_internetdb(payload)` |
| `parse_text_lines` | function | `estorides_core/parsers.py:900` | `def parse_text_lines(payload)` |
| `parse_threatfox` | function | `estorides_core/parsers.py:443` | `def parse_threatfox(payload)` |
| `parse_twitch_user` | function | `estorides_core/parsers.py:1025` | `def parse_twitch_user(payload)` |
| `parse_twitter_user` | function | `estorides_core/parsers.py:953` | `def parse_twitter_user(payload)` |
| `parse_urlhaus` | function | `estorides_core/parsers.py:452` | `def parse_urlhaus(payload)` |
| `parse_urlhaus_payloads` | function | `estorides_core/parsers.py:461` | `def parse_urlhaus_payloads(payload)` |
| `parse_urlscan` | function | `estorides_core/parsers.py:399` | `def parse_urlscan(payload)` |
| `parse_vt_domain` | function | `estorides_core/parsers.py:319` | `def parse_vt_domain(payload)` |
| `parse_vt_file` | function | `estorides_core/parsers.py:346` | `def parse_vt_file(payload)` |
| `parse_vt_ip` | function | `estorides_core/parsers.py:298` | `def parse_vt_ip(payload)` |
| `parse_wayback_avail` | function | `estorides_core/parsers.py:434` | `def parse_wayback_avail(payload)` |
| `parse_wayback_cdx` | function | `estorides_core/parsers.py:421` | `def parse_wayback_cdx(payload)` |
| `parse_whois_text` | function | `estorides_core/parsers.py:935` | `def parse_whois_text(payload)` |
| `parse_wikidata` | function | `estorides_core/parsers.py:567` | `def parse_wikidata(payload)` |
| `parse_wikipedia` | function | `estorides_core/parsers.py:558` | `def parse_wikipedia(payload)` |
| `parse_youtube_user` | function | `estorides_core/parsers.py:988` | `def parse_youtube_user(payload)` |
| `register_parser` | function | `estorides_core/parsers.py:1188` | `def register_parser(name, description)` |
...
| `FusionResult` | class | `estorides_core/recon_fusion.py:81` | `class FusionResult` |
| `GroupedEntity` | class | `estorides_core/recon_fusion.py:43` | `class GroupedEntity` |
| `ReconFusionEngine` | class | `estorides_core/recon_fusion.py:177` | `class ReconFusionEngine` |
| `RelevanceTier` | class | `estorides_core/recon_fusion.py:24` | `class RelevanceTier(str, Enum)` |
| `__init__` | method | `estorides_core/recon_fusion.py:183` | `def __init__(self, config)` |
| `_assign_tier` | method | `estorides_core/recon_fusion.py:403` | `def _assign_tier(self, source_count, avg_reliability, direct_match)` |
| `_canonical_id` | method | `estorides_core/recon_fusion.py:109` | `def _canonical_id(etype, value)` |
| `_classify_groups` | method | `estorides_core/recon_fusion.py:338` | `def _classify_groups(self, groups, query)` |
| `_corroboration_factor` | method | `estorides_core/recon_fusion.py:134` | `def _corroboration_factor(source_count)` |
| `_deduplicate` | method | `estorides_core/recon_fusion.py:236` | `def _deduplicate(self, observations)` |
| `_direct_match_query` | method | `estorides_core/recon_fusion.py:149` | `def _direct_match_query(value, query)` |
| `_extract_key_findings` | method | `estorides_core/recon_fusion.py:154` | `def _extract_key_findings(observations)` |
| `_freshness_factor` | method | `estorides_core/recon_fusion.py:141` | `def _freshness_factor(age_hours, max_hours)` |
| `_group_by_entity` | method | `estorides_core/recon_fusion.py:254` | `def _group_by_entity(self, observations, entities)` |
| `_normalize_value` | method | `estorides_core/recon_fusion.py:104` | `def _normalize_value(etype, value)` |
| `_reliability_weight` | method | `estorides_core/recon_fusion.py:115` | `def _reliability_weight(source_name, overrides)` |
| `_reliability_weight_for_letter` | method | `estorides_core/recon_fusion.py:443` | `def _reliability_weight_for_letter(letter)` |
| `classify` | method | `estorides_core/recon_fusion.py:186` | `def classify(self, query, query_type, observations, entities)` |
| `ordered` | method | `estorides_core/recon_fusion.py:37` | `def ordered(cls)` |
| `to_dict` | method | `estorides_core/recon_fusion.py:61` | `def to_dict(self)` |
| `to_dict` | method | `estorides_core/recon_fusion.py:92` | `def to_dict(self)` |
| `run_passive_recon` | function | `estorides_core/recon_pipeline.py:22` | `def run_passive_recon(query, headers, html, cookies, employees, code_findings, third_parties, pdns_subdomains, cloud_ass` |
...
| `ConfidenceInput` | class | `estorides_core/reliability_scoring.py:242` | `class ConfidenceInput` |
| `ConfidenceResult` | class | `estorides_core/reliability_scoring.py:262` | `class ConfidenceResult` |
| `Credibility` | class | `estorides_core/reliability_scoring.py:47` | `class Credibility(int, Enum)` |
| `SourceReliability` | class | `estorides_core/reliability_scoring.py:36` | `class SourceReliability(str, Enum)` |
| `SourceType` | class | `estorides_core/reliability_scoring.py:58` | `class SourceType(str, Enum)` |
| `__post_init__` | method | `estorides_core/reliability_scoring.py:252` | `def __post_init__(self)` |
| `_clamp01` | method | `estorides_core/reliability_scoring.py:301` | `def _clamp01(value)` |
| `_corroboration_weight` | method | `estorides_core/reliability_scoring.py:279` | `def _corroboration_weight(n)` |
| `_freshness_weight` | method | `estorides_core/reliability_scoring.py:286` | `def _freshness_weight(age_seconds, half_life_days)` |
| `_validate_score` | method | `estorides_core/reliability_scoring.py:296` | `def _validate_score(value, field_name)` |
| `compute_confidence` | method | `estorides_core/reliability_scoring.py:311` | `def compute_confidence(inp)` |
| `merge_confidence` | method | `estorides_core/reliability_scoring.py:349` | `def merge_confidence(existing, new_observation)` |
| `reliability_from_name` | method | `estorides_core/reliability_scoring.py:399` | `def reliability_from_name(source_name)` |
| `source_type_from_name` | method | `estorides_core/reliability_scoring.py:414` | `def source_type_from_name(source_name)` |
...
| `DashboardSummary` | class | `estorides_core/source_health_monitoring.py:182` | `class DashboardSummary` |
| `HealthDashboard` | class | `estorides_core/source_health_monitoring.py:195` | `class HealthDashboard` |
| `SourceHealthConfig` | class | `estorides_core/source_health_monitoring.py:64` | `class SourceHealthConfig` |
| `SourceHealthInput` | class | `estorides_core/source_health_monitoring.py:120` | `class SourceHealthInput` |
| `SourceHealthResult` | class | `estorides_core/source_health_monitoring.py:156` | `class SourceHealthResult` |
| `SourceHealthStatus` | class | `estorides_core/source_health_monitoring.py:53` | `class SourceHealthStatus(str, Enum)` |
| `__post_init__` | method | `estorides_core/source_health_monitoring.py:80` | `def __post_init__(self)` |
| `__post_init__` | method | `estorides_core/source_health_monitoring.py:134` | `def __post_init__(self)` |
| `_clamp01` | method | `estorides_core/source_health_monitoring.py:224` | `def _clamp01(value)` |
| `_classify` | method | `estorides_core/source_health_monitoring.py:232` | `def _classify(success_rate, avg_latency_ms, freshness_hours, fetch_count, config)` |
| `_env_float` | function | `estorides_core/source_health_monitoring.py:28` | `def _env_float(name, default)` |
| `_env_int` | function | `estorides_core/source_health_monitoring.py:40` | `def _env_int(name, default)` |
| `build_dashboard` | method | `estorides_core/source_health_monitoring.py:317` | `def build_dashboard(records, config)` |
| `compute_health` | method | `estorides_core/source_health_monitoring.py:257` | `def compute_health(inp, config)` |
| `to_dict` | method | `estorides_core/source_health_monitoring.py:168` | `def to_dict(self)` |
| `to_dict` | method | `estorides_core/source_health_monitoring.py:206` | `def to_dict(self)` |
...
| `_category_dir_name` | method | `estorides_core/source_loader.py:225` | `def _category_dir_name(self, category)` |
| `_find_source_file` | method | `estorides_core/source_loader.py:247` | `def _find_source_file(self, name)` |
| `_load_file` | method | `estorides_core/source_loader.py:71` | `def _load_file(self, path)` |
| `_normalise` | method | `estorides_core/source_loader.py:100` | `def _normalise(self, raw)` |
| `_source_path` | method | `estorides_core/source_loader.py:241` | `def _source_path(self, name, category)` |
| `all` | method | `estorides_core/source_loader.py:191` | `def all(self)` |
| `by_category` | method | `estorides_core/source_loader.py:194` | `def by_category(self, category)` |
| `categories` | method | `estorides_core/source_loader.py:197` | `def categories(self)` |
| `delete_source_file` | method | `estorides_core/source_loader.py:329` | `def delete_source_file(self, name)` |
| `filter` | method | `estorides_core/source_loader.py:203` | `def filter(self)` |
| `get` | method | `estorides_core/source_loader.py:188` | `def get(self, name)` |
| `load` | method | `estorides_core/source_loader.py:47` | `def load(self)` |
| `names` | method | `estorides_core/source_loader.py:200` | `def names(self)` |
| `summary` | method | `estorides_core/source_loader.py:338` | `def summary(self)` |
| `write_source_file` | method | `estorides_core/source_loader.py:259` | `def write_source_file(self, data)` |
| `GuardResult` | class | `estorides_core/ssrf_guard.py:99` | `class GuardResult` |
| `SSRFError` | class | `estorides_core/ssrf_guard.py:277` | `class SSRFError(ValueError)` |
...
| `_is_host_in_blocked_literal` | method | `estorides_core/ssrf_guard.py:142` | `def _is_host_in_blocked_literal(host)` |
| `_load_allowlist` | method | `estorides_core/ssrf_guard.py:197` | `def _load_allowlist()` |
| `_matches_allowlist` | method | `estorides_core/ssrf_guard.py:180` | `def _matches_allowlist(host, allowlist)` |
| `_normalise_host` | method | `estorides_core/ssrf_guard.py:134` | `def _normalise_host(host)` |
| `_resolve` | method | `estorides_core/ssrf_guard.py:163` | `def _resolve(host)` |
| `assert_safe` | method | `estorides_core/ssrf_guard.py:270` | `def assert_safe(url)` |
| `check_url` | method | `estorides_core/ssrf_guard.py:202` | `def check_url(url)` |
...
| `InstallRecipe` | class | `estorides_core/tool_install.py:75` | `class InstallRecipe` |
| `InstallResult` | class | `estorides_core/tool_install.py:97` | `class InstallResult` |
| `_check_shell_command` | method | `estorides_core/tool_install.py:142` | `def _check_shell_command(command)` |
| `_elevate` | method | `estorides_core/tool_install.py:111` | `def _elevate(cmd)` |
| `_install_apt` | method | `estorides_core/tool_install.py:213` | `def _install_apt(recipe)` |
| `_install_git` | method | `estorides_core/tool_install.py:226` | `def _install_git(recipe)` |
| `_needs_elevation` | method | `estorides_core/tool_install.py:148` | `def _needs_elevation(command)` |
| `_recipe_path` | method | `estorides_core/tool_install.py:154` | `def _recipe_path(name)` |
| `_run` | method | `estorides_core/tool_install.py:126` | `def _run(cmd)` |
| `_verify` | method | `estorides_core/tool_install.py:334` | `def _verify(binary)` |
| `has_apt` | method | `estorides_core/tool_install.py:89` | `def has_apt(self)` |
| `has_git` | method | `estorides_core/tool_install.py:92` | `def has_git(self)` |
| `install_tool` | method | `estorides_core/tool_install.py:257` | `def install_tool(tool_name)` |
| `list_recipes` | method | `estorides_core/tool_install.py:205` | `def list_recipes()` |
| `load_recipe` | method | `estorides_core/tool_install.py:158` | `def load_recipe(name)` |
| `main` | method | `estorides_core/tool_install.py:344` | `def main(argv)` |
| `recipe_available` | method | `estorides_core/tool_install.py:191` | `def recipe_available(name)` |
| `to_dict` | method | `estorides_core/tool_install.py:107` | `def to_dict(self)` |
| `tool_available` | method | `estorides_core/tool_install.py:196` | `def tool_available(binary)` |
...
| `AuthGate` | class | `estorides_core/web_security.py:356` | `class AuthGate` |
| `WebSecurityConfig` | class | `estorides_core/web_security.py:84` | `class WebSecurityConfig` |
| `_cors_preflight` | method | `estorides_core/web_security.py:265` | `def _cors_preflight()` |
| `_current_gate` | method | `estorides_core/web_security.py:455` | `def _current_gate()` |
| `_env_bool` | method | `estorides_core/web_security.py:152` | `def _env_bool(name, default)` |
| `_env_int` | method | `estorides_core/web_security.py:141` | `def _env_int(name, default)` |
| `_env_str` | method | `estorides_core/web_security.py:134` | `def _env_str(name, default)` |
| `_extract_bearer_token` | method | `estorides_core/web_security.py:301` | `def _extract_bearer_token()` |
| `_redirect_to_https` | method | `estorides_core/web_security.py:218` | `def _redirect_to_https()` |
| `_security_headers` | method | `estorides_core/web_security.py:232` | `def _security_headers(resp)` |
| `auth_meta_for_index` | method | `estorides_core/web_security.py:377` | `def auth_meta_for_index(self)` |
| `auto_generated_token` | method | `estorides_core/web_security.py:459` | `def auto_generated_token()` |
| `build_https_url` | function | `estorides_core/web_security.py:55` | `def build_https_url(public_host, path, query_string)` |
| `check` | method | `estorides_core/web_security.py:369` | `def check(self)` |
| `enabled` | method | `estorides_core/web_security.py:366` | `def enabled(self)` |
| `install_auth_gate` | method | `estorides_core/web_security.py:436` | `def install_auth_gate(app, gate)` |
| `install_security` | method | `estorides_core/web_security.py:184` | `def install_security(app, cfg)` |
| `is_cors_enabled` | method | `estorides_core/web_security.py:125` | `def is_cors_enabled(self)` |
| `is_origin_allowed` | method | `estorides_core/web_security.py:129` | `def is_origin_allowed(self)` |
| `issue_session_cookie_kwargs` | method | `estorides_core/web_security.py:386` | `def issue_session_cookie_kwargs(self)` |
| `load_security_config` | method | `estorides_core/web_security.py:159` | `def load_security_config()` |
| `make_auth_gate` | method | `estorides_core/web_security.py:336` | `def make_auth_gate()` |
| `require_auth` | method | `estorides_core/web_security.py:403` | `def require_auth(view)` |
| `wrapper` | method | `estorides_core/web_security.py:417` | `def wrapper()` |
...
| `build_executive_summary` | method | `estorides_export/recon_report.py:92` | `def build_executive_summary(critical_findings, total_targets, domain)` |
| `build_subdomain_tree` | method | `estorides_export/recon_report.py:67` | `def build_subdomain_tree(subdomains)` |
| `generate_report` | method | `estorides_export/recon_report.py:114` | `def generate_report(query, target_scoring, metadata)` |
...
| `_analysis` | function | `estorides_export/report.py:156` | `def _analysis(case)` |
...
| `_meta_footer` | function | `estorides_export/report.py:177` | `def _meta_footer(case, sources_queried, sources_succeeded)` |
| `_tldr` | function | `estorides_export/report.py:37` | `def _tldr(case, entities, sources_queried, sources_succeeded, diff)` |
| `render_markdown_report` | function | `estorides_export/report.py:194` | `def render_markdown_report(case, entities, sources_queried, sources_succeeded, diff)` |
...
| `format_context` | function | `estorides_llm/intelligence_prompts.py:98` | `def format_context(sources)` |
| `AnthropicBackend` | class | `estorides_llm/manager.py:309` | `class AnthropicBackend` |
| `LLMBackend` | class | `estorides_llm/manager.py:53` | `class LLMBackend(Protocol)` |
| `LLMManager` | class | `estorides_llm/manager.py:349` | `class LLMManager` |
| `OllamaBackend` | class | `estorides_llm/manager.py:113` | `class OllamaBackend` |
| `OpenAIBackend` | class | `estorides_llm/manager.py:295` | `class OpenAIBackend(_OpenAICompatibleBackend)` |
| `OpenRouterBackend` | class | `estorides_llm/manager.py:302` | `class OpenRouterBackend(_OpenAICompatibleBackend)` |
| `_OpenAICompatibleBackend` | class | `estorides_llm/manager.py:259` | `class _OpenAICompatibleBackend` |
| `__call__` | method | `estorides_llm/manager.py:62` | `def __call__(self, prompt, context, max_tokens, temperature, request_timeout)` |
| `__call__` | method | `estorides_llm/manager.py:220` | `def __call__(self, prompt, context, max_tokens, temperature, request_timeout)` |
| `__call__` | method | `estorides_llm/manager.py:267` | `def __call__(self, prompt, context, max_tokens, temperature, request_timeout)` |
| `__call__` | method | `estorides_llm/manager.py:312` | `def __call__(self, prompt, context, max_tokens, temperature, request_timeout)` |
| `__init__` | method | `estorides_llm/manager.py:350` | `def __init__(self)` |
| `_resolve_model` | method | `estorides_llm/manager.py:127` | `def _resolve_model(self, request_timeout)` |
| `_stub_response` | method | `estorides_llm/manager.py:451` | `def _stub_response(self, prompt, context)` |
| `deco` | method | `estorides_llm/manager.py:98` | `def deco(backend_or_cls)` |
| `generate` | method | `estorides_llm/manager.py:366` | `def generate(self, prompt)` |
| `get_ollama_status` | method | `estorides_llm/manager.py:407` | `def get_ollama_status(self)` |
| `get_status` | method | `estorides_llm/manager.py:117` | `def get_status()` |
| `register` | method | `estorides_llm/manager.py:90` | `def register(name)` |
| `stream` | method | `estorides_llm/manager.py:415` | `def stream(self, prompt)` |
| `stream_generate` | method | `estorides_llm/manager.py:73` | `def stream_generate(self, prompt, context, model, temperature, request_timeout)` |
| `stream_generate` | method | `estorides_llm/manager.py:181` | `def stream_generate(self, prompt, context, model, temperature, request_timeout)` |
| `_RunStreamJob` | class | `estorides_web.py:122` | `class _RunStreamJob` |
| `__init__` | method | `estorides_web.py:130` | `def __init__(self, job_id, query, query_type, case_id)` |
| `_arg_int` | function | `estorides_web.py:92` | `def _arg_int(name, default)` |
| `_client_ip` | function | `estorides_web.py:75` | `def _client_ip()` |
| `_drive` | method | `estorides_web.py:1539` | `def _drive()` |
| `_new_stream_job_id` | method | `estorides_web.py:160` | `def _new_stream_job_id()` |
| `_rate_limit_decorator` | method | `estorides_web.py:165` | `def _rate_limit_decorator()` |
| `_run` | method | `estorides_web.py:1652` | `def _run()` |
| `_send_and_cleanup` | function | `estorides_web.py:108` | `def _send_and_cleanup(p, tmpdir)` |
| `_serve_loop` | method | `estorides_web.py:1700` | `def _serve_loop()` |
| `_shape_for_ui` | method | `estorides_web.py:1713` | `def _shape_for_ui(result)` |
| `_watch_runner` | method | `estorides_web.py:1065` | `def _watch_runner(swatch)` |
| `_worker` | method | `estorides_web.py:309` | `def _worker()` |
| `admin_sources` | method | `estorides_web.py:898` | `def admin_sources()` |
| `api_alerts_channels` | method | `estorides_web.py:1196` | `def api_alerts_channels()` |
| `api_alerts_test` | method | `estorides_web.py:1205` | `def api_alerts_test()` |
| `api_analyze_stream` | method | `estorides_web.py:1639` | `def api_analyze_stream()` |
| `api_cases_delete` | method | `estorides_web.py:617` | `def api_cases_delete(case_id)` |
| `api_cases_diff` | method | `estorides_web.py:655` | `def api_cases_diff()` |
| `api_cases_get` | method | `estorides_web.py:602` | `def api_cases_get(case_id)` |
| `api_cases_list` | method | `estorides_web.py:588` | `def api_cases_list()` |
| `api_cases_save` | method | `estorides_web.py:626` | `def api_cases_save(case_id)` |
| `api_discover_jobs` | method | `estorides_web.py:1436` | `def api_discover_jobs()` |
| `api_discover_start` | method | `estorides_web.py:1390` | `def api_discover_start()` |
| `api_discover_stop` | method | `estorides_web.py:1442` | `def api_discover_stop()` |
| `api_discover_stream` | method | `estorides_web.py:1454` | `def api_discover_stream()` |
| `api_export` | method | `estorides_web.py:511` | `def api_export(fmt)` |
| `api_feeds` | method | `estorides_web.py:480` | `def api_feeds()` |
| `api_fusion_analytics_consensus` | method | `estorides_web.py:875` | `def api_fusion_analytics_consensus(eid)` |
| `api_fusion_analytics_corroboration_matrix` | method | `estorides_web.py:997` | `def api_fusion_analytics_corroboration_matrix()` |
| `api_fusion_analytics_entity_summary` | method | `estorides_web.py:853` | `def api_fusion_analytics_entity_summary(eid)` |
| `api_fusion_analytics_entity_timeline` | method | `estorides_web.py:842` | `def api_fusion_analytics_entity_timeline(eid)` |
| `api_fusion_analytics_source_stats` | method | `estorides_web.py:864` | `def api_fusion_analytics_source_stats(source_name)` |
| `api_fusion_analytics_top_changed` | method | `estorides_web.py:886` | `def api_fusion_analytics_top_changed()` |
| `api_fusion_entities` | method | `estorides_web.py:801` | `def api_fusion_entities()` |
| `api_fusion_entity` | method | `estorides_web.py:823` | `def api_fusion_entity(eid)` |
| `api_fusion_sources` | method | `estorides_web.py:791` | `def api_fusion_sources()` |
| `api_fusion_stats` | method | `estorides_web.py:782` | `def api_fusion_stats()` |
| `api_graph` | method | `estorides_web.py:404` | `def api_graph()` |
| `api_intel_graph` | method | `estorides_web.py:721` | `def api_intel_graph()` |
| `api_intel_resolve` | method | `estorides_web.py:681` | `def api_intel_resolve()` |
| `api_intel_stats` | method | `estorides_web.py:762` | `def api_intel_stats()` |
| `api_ollama_status` | method | `estorides_web.py:267` | `def api_ollama_status()` |
| `api_osiris_bgp` | method | `estorides_web.py:1285` | `def api_osiris_bgp()` |
| `api_osiris_github` | method | `estorides_web.py:1330` | `def api_osiris_github()` |
| `api_osiris_kev` | method | `estorides_web.py:1360` | `def api_osiris_kev()` |
| `api_osiris_leaks` | method | `estorides_web.py:1345` | `def api_osiris_leaks()` |
| `api_osiris_mac` | method | `estorides_web.py:1300` | `def api_osiris_mac()` |
| `api_osiris_malware` | method | `estorides_web.py:1370` | `def api_osiris_malware()` |
| `api_osiris_phone` | method | `estorides_web.py:1315` | `def api_osiris_phone()` |
| `api_osiris_threats` | method | `estorides_web.py:1377` | `def api_osiris_threats()` |
| `api_run` | method | `estorides_web.py:348` | `def api_run()` |
| `api_run_stream` | method | `estorides_web.py:1588` | `def api_run_stream()` |
| `api_run_stream_start` | method | `estorides_web.py:1509` | `def api_run_stream_start()` |
| `api_run_stream_stop` | method | `estorides_web.py:1576` | `def api_run_stream_stop()` |
| `api_scheduler_status` | method | `estorides_web.py:1222` | `def api_scheduler_status()` |
| `api_socmint_discover` | method | `estorides_web.py:1044` | `def api_socmint_discover()` |
| `api_socmint_platforms` | method | `estorides_web.py:1035` | `def api_socmint_platforms()` |
| `api_socmint_resolve` | method | `estorides_web.py:1012` | `def api_socmint_resolve()` |
| `api_sources_yaml_create` | method | `estorides_web.py:941` | `def api_sources_yaml_create()` |
| `api_sources_yaml_delete` | method | `estorides_web.py:981` | `def api_sources_yaml_delete(name)` |
| `api_sources_yaml_list` | method | `estorides_web.py:915` | `def api_sources_yaml_list()` |
| `api_sources_yaml_update` | method | `estorides_web.py:962` | `def api_sources_yaml_update(name)` |
| `api_status` | method | `estorides_web.py:261` | `def api_status()` |
| `api_tool_install` | method | `estorides_web.py:297` | `def api_tool_install(name)` |
| `api_tool_install_status` | method | `estorides_web.py:338` | `def api_tool_install_status(name)` |
| `api_tools_list` | method | `estorides_web.py:277` | `def api_tools_list()` |
| `api_transform_run` | method | `estorides_web.py:1256` | `def api_transform_run()` |
| `api_transforms` | method | `estorides_web.py:1241` | `def api_transforms()` |
| `api_watch_create` | method | `estorides_web.py:1098` | `def api_watch_create()` |
| `api_watch_delete` | method | `estorides_web.py:1146` | `def api_watch_delete(watch_id)` |
| `api_watch_disable` | method | `estorides_web.py:1172` | `def api_watch_disable(watch_id)` |
| `api_watch_enable` | method | `estorides_web.py:1158` | `def api_watch_enable(watch_id)` |
| `api_watch_get` | method | `estorides_web.py:1133` | `def api_watch_get(watch_id)` |
| `api_watch_history` | method | `estorides_web.py:1185` | `def api_watch_history(watch_id)` |
| `api_watch_list` | method | `estorides_web.py:1088` | `def api_watch_list()` |
| `create_app` | method | `estorides_web.py:209` | `def create_app()` |
| `deco` | method | `estorides_web.py:172` | `def deco(view)` |
| `done` | method | `estorides_web.py:150` | `def done(self)` |
| `gen` | method | `estorides_web.py:1467` | `def gen()` |
| `gen` | method | `estorides_web.py:1594` | `def gen()` |
| `gen` | method | `estorides_web.py:1667` | `def gen()` |
| `index` | method | `estorides_web.py:240` | `def index()` |
| `should_stop` | method | `estorides_web.py:142` | `def should_stop(self)` |
| `status` | method | `estorides_web.py:146` | `def status(self)` |
| `stop` | method | `estorides_web.py:139` | `def stop(self)` |
| `wrapper` | method | `estorides_web.py:174` | `def wrapper()` |
| `install_full` | function | `install.sh:51` | `` |
| `install_minimal` | function | `install.sh:55` | `` |
| `CLUSTER_PALETTE` | function | `static/js/estorides.js:1100` | `` |
| `TELEMETRY` | function | `static/js/estorides.js:30` | `` |
| `_installErrMsg` | function | `static/js/estorides.js:232` | `` |
| `_redrawGraph` | function | `static/js/estorides.js:1556` | `` |
| `_sanitizeInput` | function | `static/js/estorides.js:2402` | `` |
| `_sseAuthToken` | function | `static/js/estorides.js:2807` | `` |
| `_sseUrl` | function | `static/js/estorides.js:2811` | `` |
| `actions` | function | `static/js/estorides.js:2411` | `` |
| `add` | function | `static/js/estorides.js:1375` | `` |
| `addDiscoverEntityToTab` | function | `static/js/estorides.js:2989` | `` |
| `addText` | function | `static/js/estorides.js:1381` | `` |
| `analyseEntity` | function | `static/js/estorides.js:928` | `` |
| `appendStreamEntity` | function | `static/js/estorides.js:657` | `` |
| `appendStreamObservation` | function | `static/js/estorides.js:635` | `` |
| `applyLevelStyles` | function | `static/js/estorides.js:1326` | `` |
| `applyResultFilters` | function | `static/js/estorides.js:248` | `` |
| `bindResultFilters` | function | `static/js/estorides.js:269` | `` |
| `boxQ` | function | `static/js/estorides.js:857` | `` |
| `buildCaseMapCoords` | function | `static/js/estorides.js:2137` | `` |
| `buildMapCoords` | function | `static/js/estorides.js:1688` | `` |
| `buildResultCard` | function | `static/js/estorides.js:127` | `` |
| `c` | function | `static/js/estorides.js:1133` | `` |
| `c` | function | `static/js/estorides.js:1203` | `` |
| `caseActionDiff` | function | `static/js/estorides.js:2280` | `` |
| `caseActionReport` | function | `static/js/estorides.js:2341` | `` |
| `caseActionSave` | function | `static/js/estorides.js:2259` | `` |
| `cat` | function | `static/js/estorides.js:250` | `` |
| `check` | function | `static/js/estorides.js:3048` | `` |
| `cid` | function | `static/js/estorides.js:1153` | `` |
| `clearAll` | function | `static/js/estorides.js:686` | `` |
| `clearMap` | function | `static/js/estorides.js:317` | `` |
| `close` | function | `static/js/estorides.js:2425` | `` |
| `clusterColor` | function | `static/js/estorides.js:1131` | `` |
| `colorFor` | function | `static/js/estorides.js:1788` | `` |
| `colorForKind` | function | `static/js/estorides.js:1886` | `` |
| `confirmModal` | function | `static/js/estorides.js:2464` | `` |
| `debounce` | function | `static/js/estorides.js:2181` | `` |
| `deriveClusters` | function | `static/js/estorides.js:1150` | `` |
| `detectQueryTypeLocal` | function | `static/js/estorides.js:44` | `` |
| `doSearch` | function | `static/js/estorides.js:2710` | `` |
| `drawGraph` | function | `static/js/estorides.js:2004` | `` |
| `drawGraphWithExtras` | function | `static/js/estorides.js:1049` | `` |
| `drawHulls` | function | `static/js/estorides.js:1525` | `` |
| `entities` | function | `static/js/estorides.js:2062` | `` |
| `escapeAttr` | function | `static/js/estorides.js:1652` | `` |
| `escapeHTML` | function | `static/js/estorides.js:2231` | `` |
| `escapeHtml` | function | `static/js/estorides.js:3017` | `` |
| `expandNode` | function | `static/js/estorides.js:961` | `` |
| `filterTimeline` | function | `static/js/estorides.js:1955` | `` |
| `flush` | function | `static/js/estorides.js:886` | `` |
| `flushDiscoverEntities` | function | `static/js/estorides.js:3029` | `` |
| `fmtTime` | function | `static/js/estorides.js:1944` | `` |
| `focusGraphNodeByValue` | function | `static/js/estorides.js:290` | `` |
| `focusNode` | function | `static/js/estorides.js:1334` | `` |
| `frac` | function | `static/js/estorides.js:1931` | `` |
| `handleDiscoverEvent` | function | `static/js/estorides.js:2950` | `` |
| `handleRunStreamEvent` | function | `static/js/estorides.js:597` | `` |
| `hideContextMenu` | function | `static/js/estorides.js:1193` | `` |
| `hideDiscoverProgress` | function | `static/js/estorides.js:2854` | `` |
| `hideTooltip` | function | `static/js/estorides.js:1163` | `` |
| `hideWorkingIndicator` | function | `static/js/estorides.js:1573` | `` |
| `k` | function | `static/js/estorides.js:1002` | `` |
| `labelFor` | function | `static/js/estorides.js:1202` | `` |
| `levelOf` | function | `static/js/estorides.js:1127` | `` |
| `loadAnalysisModels` | function | `static/js/estorides.js:768` | `` |
| `loadCases` | function | `static/js/estorides.js:2035` | `` |
| `loadFusionEntityDetail` | function | `static/js/estorides.js:2748` | `` |
| `loadFusionSearch` | function | `static/js/estorides.js:2703` | `` |
| `loadFusionStats` | function | `static/js/estorides.js:2655` | `` |
| `loadFusionTab` | function | `static/js/estorides.js:2649` | `` |
| `loadFusionTopChanged` | function | `static/js/estorides.js:2674` | `` |
| `loadSidebarCollapsed` | function | `static/js/estorides.js:2570` | `` |
| `loadSidebarWidth` | function | `static/js/estorides.js:2556` | `` |
| `makeModelPill` | function | `static/js/estorides.js:787` | `` |
| `maybePlotDiscoverEntity` | function | `static/js/estorides.js:3022` | `` |
| `mergeExpansionIntoGraph` | function | `static/js/estorides.js:989` | `` |
| `obs` | function | `static/js/estorides.js:1898` | `` |
| `obs` | function | `static/js/estorides.js:2063` | `` |
| `on` | class | `static/js/estorides.js:1741` | `` |
| `openCaseDetail` | function | `static/js/estorides.js:2061` | `` |
| `openModal` | function | `static/js/estorides.js:2405` | `` |
| `out` | function | `static/js/estorides.js:235` | `` |
| `plotPoints` | function | `static/js/estorides.js:322` | `` |
| `pollToolInstall` | function | `static/js/estorides.js:209` | `` |
| `populateCategoryFilter` | function | `static/js/estorides.js:242` | `` |
| `promptModal` | function | `static/js/estorides.js:2440` | `` |
| `pump` | function | `static/js/estorides.js:907` | `` |
| `pushLink` | function | `static/js/estorides.js:1073` | `` |
| `q` | function | `static/js/estorides.js:2036` | `` |
| `reanalyze` | function | `static/js/estorides.js:838` | `` |
| `removed` | function | `static/js/estorides.js:2311` | `` |
| `renderAnalysis` | function | `static/js/estorides.js:800` | `` |
| `renderAnalysisModels` | function | `static/js/estorides.js:775` | `` |
| `renderCaseDiffPanel` | function | `static/js/estorides.js:2300` | `` |
| `renderCaseItem` | function | `static/js/estorides.js:2155` | `` |
| `renderEntities` | function | `static/js/estorides.js:1807` | `` |
| `renderGraphCore` | function | `static/js/estorides.js:1455` | `` |
| `renderGraphSummary` | function | `static/js/estorides.js:1857` | `` |
| `renderMarkdown` | function | `static/js/estorides.js:816` | `` |
| `renderResult` | function | `static/js/estorides.js:720` | `` |
| `renderTieredResults` | function | `static/js/estorides.js:1586` | `` |
| `renderTimeline` | function | `static/js/estorides.js:1894` | `` |
| `replotStreamData` | function | `static/js/estorides.js:424` | `` |
| `requestToolInstall` | function | `static/js/estorides.js:186` | `` |
| `resolverTypeFor` | function | `static/js/estorides.js:1107` | `` |
| `restoreCaseToWorkspace` | function | `static/js/estorides.js:2116` | `` |
| `rows` | function | `static/js/estorides.js:2308` | `` |
| `runQuery` | function | `static/js/estorides.js:451` | `` |
| `runQueryBlocking` | function | `static/js/estorides.js:521` | `` |
| `runTransform` | function | `static/js/estorides.js:1346` | `` |
| `safeColor` | function | `static/js/estorides.js:1141` | `` |
| `sanitizeHTML` | function | `static/js/estorides.js:1167` | `` |
| `saveLevelOverrides` | function | `static/js/estorides.js:1123` | `` |
| `saveSidebarCollapsed` | function | `static/js/estorides.js:2578` | `` |
| `saveSidebarWidth` | function | `static/js/estorides.js:2567` | `` |
| `saved` | function | `static/js/estorides.js:2159` | `` |
| `scheduleRender` | function | `static/js/estorides.js:881` | `` |
| `searchEntity` | function | `static/js/estorides.js:554` | `` |
| `selectNode` | function | `static/js/estorides.js:1364` | `` |
| `set` | function | `static/js/estorides.js:21` | `` |
| `setDiscoverProgress` | function | `static/js/estorides.js:2842` | `` |
| `setNodeLevel` | function | `static/js/estorides.js:1317` | `` |
| `setRunProgress` | function | `static/js/estorides.js:75` | `` |
| `setStatus` | function | `static/js/estorides.js:714` | `` |
| `setStatus` | function | `static/js/estorides.js:2835` | `` |
| `setStatusDot` | function | `static/js/estorides.js:1562` | `` |
| `setThinkingVisible` | function | `static/js/estorides.js:826` | `` |
| `showBridgeTooltip` | function | `static/js/estorides.js:1199` | `` |
| `showContextMenu` | function | `static/js/estorides.js:1247` | `` |
| `showEmptyState` | function | `static/js/estorides.js:96` | `` |
| `showFriendlyError` | function | `static/js/estorides.js:277` | `` |
| `showNodeTooltip` | function | `static/js/estorides.js:1228` | `` |
| `showReportModal` | function | `static/js/estorides.js:2377` | `` |
| `showToast` | function | `static/js/estorides.js:55` | `` |
| `showTooltipAt` | function | `static/js/estorides.js:1182` | `` |
| `showWorkingIndicator` | function | `static/js/estorides.js:1568` | `` |
| `sig` | function | `static/js/estorides.js:659` | `` |
| `sig` | function | `static/js/estorides.js:2994` | `` |
| `startDiscover` | function | `static/js/estorides.js:2859` | `` |
| `status` | function | `static/js/estorides.js:137` | `` |
| `status` | function | `static/js/estorides.js:251` | `` |
| `stopDiscover` | function | `static/js/estorides.js:2933` | `` |
| `stopRunStream` | function | `static/js/estorides.js:436` | `` |
| `summariseObservation` | function | `static/js/estorides.js:102` | `` |
| `switchCanvasTab` | function | `static/js/estorides.js:303` | `` |
| `switchSidebarTab` | function | `static/js/estorides.js:299` | `` |
| `switchSidebarTab` | function | `static/js/estorides.js:2636` | `` |
| `tag` | function | `static/js/estorides.js:2526` | `` |
| `text` | function | `static/js/estorides.js:249` | `` |
| `to` | class | `static/js/estorides.js:382` | `` |
| `toggleThinking` | function | `static/js/estorides.js:833` | `` |
| `toggleTierSection` | function | `static/js/estorides.js:1578` | `` |
| `toolBinary` | function | `static/js/estorides.js:131` | `` |
| `tr` | function | `static/js/estorides.js:1297` | `` |
| `tr` | function | `static/js/estorides.js:1432` | `` |
| `truncate` | function | `static/js/estorides.js:2236` | `` |
| `updateQueryChip` | function | `static/js/estorides.js:65` | `` |
| `validCoord` | function | `static/js/estorides.js:1784` | `` |
...
| `TestSourceAdded` | class | `tests/test_change_detection.py:199` | `class TestSourceAdded` |
| `TestSourceRemoved` | class | `tests/test_change_detection.py:386` | `class TestSourceRemoved` |
| `_entity` | function | `tests/test_change_detection.py:28` | `def _entity(eid, etype, value)` |
| `test_after_none_returns_empty_report` | method | `tests/test_change_detection.py:150` | `def test_after_none_returns_empty_report(self)` |
| `test_before_none_reports_all_as_new` | method | `tests/test_change_detection.py:128` | `def test_before_none_reports_all_as_new(self)` |
| `test_change_is_frozen` | method | `tests/test_change_detection.py:531` | `def test_change_is_frozen(self)` |
| `test_change_report_is_frozen` | method | `tests/test_change_detection.py:546` | `def test_change_report_is_frozen(self)` |
| `test_diff_is_frozen` | method | `tests/test_change_detection.py:541` | `def test_diff_is_frozen(self)` |
| `test_disappeared_outside_grace_emits_change` | method | `tests/test_change_detection.py:181` | `def test_disappeared_outside_grace_emits_change(self)` |
| `test_disappeared_within_grace_is_ignored` | method | `tests/test_change_detection.py:169` | `def test_disappeared_within_grace_is_ignored(self)` |
| `test_edge_added_emits_change` | method | `tests/test_change_detection.py:439` | `def test_edge_added_emits_change(self)` |
| `test_edge_removed_emits_change` | method | `tests/test_change_detection.py:462` | `def test_edge_removed_emits_change(self)` |
| `test_entity_id_empty_raises` | method | `tests/test_change_detection.py:284` | `def test_entity_id_empty_raises(self)` |
| `test_entity_type_empty_raises` | method | `tests/test_change_detection.py:288` | `def test_entity_type_empty_raises(self)` |
| `test_entity_value_empty_raises` | method | `tests/test_change_detection.py:292` | `def test_entity_value_empty_raises(self)` |
| `test_hostile_key_does_not_crash` | method | `tests/test_change_detection.py:322` | `def test_hostile_key_does_not_crash(self, hostile_key)` |
| `test_input_order_does_not_affect_output` | method | `tests/test_change_detection.py:366` | `def test_input_order_does_not_affect_output(self)` |
| `test_large_confidence_shift_emits_change` | method | `tests/test_change_detection.py:491` | `def test_large_confidence_shift_emits_change(self)` |
| `test_max_changes_caps_output` | method | `tests/test_change_detection.py:258` | `def test_max_changes_caps_output(self)` |
| `test_max_changes_too_small_raises` | method | `tests/test_change_detection.py:302` | `def test_max_changes_too_small_raises(self)` |
| `test_min_change_score_out_of_range_raises` | method | `tests/test_change_detection.py:296` | `def test_min_change_score_out_of_range_raises(self)` |
| `test_min_reliability_e_excludes_f_source` | method | `tests/test_change_detection.py:229` | `def test_min_reliability_e_excludes_f_source(self)` |
| `test_new_change_score_in_high_band` | method | `tests/test_change_detection.py:84` | `def test_new_change_score_in_high_band(self)` |
| `test_new_source_on_existing_entity_emits_source_added` | method | `tests/test_change_detection.py:202` | `def test_new_source_on_existing_entity_emits_source_added(self)` |
| `test_one_new_entity_emits_one_new_change` | method | `tests/test_change_detection.py:59` | `def test_one_new_entity_emits_one_new_change(self)` |
| `test_property_change_emits_one_change` | method | `tests/test_change_detection.py:102` | `def test_property_change_emits_one_change(self)` |
| `test_same_input_same_ids_and_scores` | method | `tests/test_change_detection.py:349` | `def test_same_input_same_ids_and_scores(self)` |
| `test_small_confidence_shift_ignored` | method | `tests/test_change_detection.py:509` | `def test_small_confidence_shift_ignored(self)` |
| `test_source_removed_emits_change` | method | `tests/test_change_detection.py:389` | `def test_source_removed_emits_change(self)` |
| `test_source_removed_filtered_by_min_score` | method | `tests/test_change_detection.py:410` | `def test_source_removed_filtered_by_min_score(self)` |
| `TestBucketNamePermutations` | class | `tests/test_cloud_asset_discovery.py:103` | `class TestBucketNamePermutations` |
| `TestBucketWithListing` | class | `tests/test_cloud_asset_discovery.py:40` | `class TestBucketWithListing` |
| `TestCloudFrontDetection` | class | `tests/test_cloud_asset_discovery.py:77` | `class TestCloudFrontDetection` |
| `TestFirebaseDiscovery` | class | `tests/test_cloud_asset_discovery.py:90` | `class TestFirebaseDiscovery` |
| `TestNoAssets` | class | `tests/test_cloud_asset_discovery.py:58` | `class TestNoAssets` |
| `TestPublicS3Bucket` | class | `tests/test_cloud_asset_discovery.py:27` | `class TestPublicS3Bucket` |
| `TestRateLimiting` | class | `tests/test_cloud_asset_discovery.py:127` | `class TestRateLimiting` |
| `TestReadOnlyMethods` | class | `tests/test_cloud_asset_discovery.py:68` | `class TestReadOnlyMethods` |
| `_make_asset` | function | `tests/test_cloud_asset_discovery.py:16` | `def _make_asset(provider, url, accessible, listing)` |
| `test_accessible_bucket_returned` | method | `tests/test_cloud_asset_discovery.py:28` | `def test_accessible_bucket_returned(self)` |
| `test_assess_bucket_uses_get_only` | method | `tests/test_cloud_asset_discovery.py:69` | `def test_assess_bucket_uses_get_only(self)` |
| `test_cloudfront_cname_detected` | method | `tests/test_cloud_asset_discovery.py:78` | `def test_cloudfront_cname_detected(self)` |
| `test_empty_when_no_cloud_assets` | method | `tests/test_cloud_asset_discovery.py:59` | `def test_empty_when_no_cloud_assets(self)` |
| `test_firebase_accessible` | method | `tests/test_cloud_asset_discovery.py:91` | `def test_firebase_accessible(self)` |
| `test_generates_common_permutations` | method | `tests/test_cloud_asset_discovery.py:104` | `def test_generates_common_permutations(self)` |
| `test_listing_bucket_has_files` | method | `tests/test_cloud_asset_discovery.py:41` | `def test_listing_bucket_has_files(self)` |
| `test_rate_limit_constant_defined` | method | `tests/test_cloud_asset_discovery.py:128` | `def test_rate_limit_constant_defined(self)` |
| `test_strips_tld_for_permutations` | method | `tests/test_cloud_asset_discovery.py:114` | `def test_strips_tld_for_permutations(self)` |
| `TestAwsKeyDetection` | class | `tests/test_code_exposure.py:17` | `class TestAwsKeyDetection` |
| `TestClassifyFindingTypes` | class | `tests/test_code_exposure.py:103` | `class TestClassifyFindingTypes` |
| `TestEnvFileDetection` | class | `tests/test_code_exposure.py:62` | `class TestEnvFileDetection` |
| `TestInternalUrlDetection` | class | `tests/test_code_exposure.py:54` | `class TestInternalUrlDetection` |
| `TestMultiPlatform` | class | `tests/test_code_exposure.py:81` | `class TestMultiPlatform` |
| `TestNoFindings` | class | `tests/test_code_exposure.py:38` | `class TestNoFindings` |
| `TestPlaceholderCredentials` | class | `tests/test_code_exposure.py:70` | `class TestPlaceholderCredentials` |
| `TestRateLimited` | class | `tests/test_code_exposure.py:47` | `class TestRateLimited` |
| `TestSnippetBounded` | class | `tests/test_code_exposure.py:95` | `class TestSnippetBounded` |
| `test_aggregates_multi_source` | method | `tests/test_code_exposure.py:82` | `def test_aggregates_multi_source(self)` |
| `test_api_key_detection` | method | `tests/test_code_exposure.py:109` | `def test_api_key_detection(self)` |
| `test_detects_aws_key_as_critical` | method | `tests/test_code_exposure.py:18` | `def test_detects_aws_key_as_critical(self)` |
| `test_empty_when_no_repos` | method | `tests/test_code_exposure.py:39` | `def test_empty_when_no_repos(self)` |
| `test_env_file_is_critical_config` | method | `tests/test_code_exposure.py:63` | `def test_env_file_is_critical_config(self)` |
| `test_example_key_marked_info` | method | `tests/test_code_exposure.py:75` | `def test_example_key_marked_info(self)` |
| `test_internal_url_is_high_severity` | method | `tests/test_code_exposure.py:55` | `def test_internal_url_is_high_severity(self)` |
| `test_placeholder_marked_info` | method | `tests/test_code_exposure.py:71` | `def test_placeholder_marked_info(self)` |
| `test_returns_partial_on_rate_limit` | method | `tests/test_code_exposure.py:48` | `def test_returns_partial_on_rate_limit(self)` |
| `test_snippet_under_200_chars` | method | `tests/test_code_exposure.py:96` | `def test_snippet_under_200_chars(self)` |
| `test_ssh_key_detection` | method | `tests/test_code_exposure.py:104` | `def test_ssh_key_detection(self)` |
| `test_validates_aws_key_format` | method | `tests/test_code_exposure.py:32` | `def test_validates_aws_key_format(self)` |
| `_strip_js_comments_and_strings_outside_templates` | function | `tests/test_csp_safe_styles.py:55` | `def _strip_js_comments_and_strings_outside_templates(js_text)` |
| `_strip_template_jinja` | function | `tests/test_csp_safe_styles.py:41` | `def _strip_template_jinja(template_text)` |
| `test_csp_policy_does_not_relax_for_unsafe_inline` | function | `tests/test_csp_safe_styles.py:201` | `def test_csp_policy_does_not_relax_for_unsafe_inline()` |
| `test_csp_policy_is_unchanged_after_refactor` | function | `tests/test_csp_safe_styles.py:225` | `def test_csp_policy_is_unchanged_after_refactor()` |
| `test_css_has_required_class` | function | `tests/test_csp_safe_styles.py:189` | `def test_css_has_required_class(selector)` |
| `test_dynamic_cluster_color_uses_cssom_assignment` | function | `tests/test_csp_safe_styles.py:252` | `def test_dynamic_cluster_color_uses_cssom_assignment()` |
| `test_dynamic_kind_color_uses_cssom_assignment` | function | `tests/test_csp_safe_styles.py:272` | `def test_dynamic_kind_color_uses_cssom_assignment()` |
| `test_estorides_js_has_no_style_in_template_literals` | function | `tests/test_csp_safe_styles.py:111` | `def test_estorides_js_has_no_style_in_template_literals()` |
| `test_index_html_has_no_style_attribute` | function | `tests/test_csp_safe_styles.py:90` | `def test_index_html_has_no_style_attribute()` |
| `test_offscreen_element_uses_hidden_attribute` | function | `tests/test_csp_safe_styles.py:145` | `def test_offscreen_element_uses_hidden_attribute(element_id)` |
| `test_rendered_template_has_no_style_attribute_and_uses_hidden` | function | `tests/test_csp_safe_styles.py:289` | `def test_rendered_template_has_no_style_attribute_and_uses_hidden()` |
| `_FakeCompleted` | class | `tests/test_encrypted_export.py:21` | `class _FakeCompleted` |
| `__init__` | method | `tests/test_encrypted_export.py:22` | `def __init__(self, rc, stderr)` |
| `_kg_with_one_node` | method | `tests/test_encrypted_export.py:27` | `def _kg_with_one_node()` |
| `_patch_age_ok` | method | `tests/test_encrypted_export.py:33` | `def _patch_age_ok()` |
| `_run` | method | `tests/test_encrypted_export.py:35` | `def _run(cmd, stdin, stdout, stderr, check)` |
| `_run_fail` | method | `tests/test_encrypted_export.py:66` | `def _run_fail(cmd, stdin, stdout, stderr, check)` |
| `test_misp_encrypted_removes_plaintext` | method | `tests/test_encrypted_export.py:52` | `def test_misp_encrypted_removes_plaintext(tmp_path)` |
| `test_stix_encrypted_removes_plaintext` | method | `tests/test_encrypted_export.py:43` | `def test_stix_encrypted_removes_plaintext(tmp_path)` |
| `test_stix_encrypted_removes_plaintext_on_failure` | method | `tests/test_encrypted_export.py:61` | `def test_stix_encrypted_removes_plaintext_on_failure(tmp_path)` |
| `TestCanonicalEntityRoundtrip` | class | `tests/test_entity_resolution.py:347` | `class TestCanonicalEntityRoundtrip` |
| `TestCanonicalId` | class | `tests/test_entity_resolution.py:133` | `class TestCanonicalId` |
| `TestCanonicalIdDeterministic` | class | `tests/test_entity_resolution.py:394` | `class TestCanonicalIdDeterministic` |
| `TestCrossRunStability` | class | `tests/test_entity_resolution.py:448` | `class TestCrossRunStability` |
| `TestCrossScriptPersonFusion` | class | `tests/test_entity_resolution.py:155` | `class TestCrossScriptPersonFusion` |
| `TestDeterministicTypeNoFuzzyMatch` | class | `tests/test_entity_resolution.py:246` | `class TestDeterministicTypeNoFuzzyMatch` |
| `TestDifferentInputDifferentId` | class | `tests/test_entity_resolution.py:406` | `class TestDifferentInputDifferentId` |
| `TestDistinctPersonsStaySeparate` | class | `tests/test_entity_resolution.py:326` | `class TestDistinctPersonsStaySeparate` |
| `TestDomainCaseVariantMerge` | class | `tests/test_entity_resolution.py:194` | `class TestDomainCaseVariantMerge` |
| `TestEdgeCases` | class | `tests/test_entity_resolution.py:418` | `class TestEdgeCases` |
| `TestEmptyInput` | class | `tests/test_entity_resolution.py:382` | `class TestEmptyInput` |
| `TestIdenticalIpsMerge` | class | `tests/test_entity_resolution.py:272` | `class TestIdenticalIpsMerge` |
| `TestJaroWinkler` | class | `tests/test_entity_resolution.py:68` | `class TestJaroWinkler` |
| `TestLookAlikeDomainsSurfaceAsLink` | class | `tests/test_entity_resolution.py:221` | `class TestLookAlikeDomainsSurfaceAsLink` |
| `TestNearIpsNeverFuse` | class | `tests/test_entity_resolution.py:289` | `class TestNearIpsNeverFuse` |
| `TestNormalization` | class | `tests/test_entity_resolution.py:89` | `class TestNormalization` |
| `TestOrgSuffixFolding` | class | `tests/test_entity_resolution.py:309` | `class TestOrgSuffixFolding` |
| `TestTransliteration` | class | `tests/test_entity_resolution.py:42` | `class TestTransliteration` |
| `_by_value` | function | `tests/test_entity_resolution.py:32` | `def _by_value(result, value)` |
| `_ent` | function | `tests/test_entity_resolution.py:28` | `def _ent(etype, value, source, confidence)` |
| `test_asn_normalised` | method | `tests/test_entity_resolution.py:126` | `def test_asn_normalised(self)` |
| `test_blank_value_does_not_crash` | method | `tests/test_entity_resolution.py:421` | `def test_blank_value_does_not_crash(self)` |
| `test_classic_jaro_winkler_bound` | method | `tests/test_entity_resolution.py:77` | `def test_classic_jaro_winkler_bound(self)` |
| `test_confidence_boosted_by_multiple_sources` | method | `tests/test_entity_resolution.py:434` | `def test_confidence_boosted_by_multiple_sources(self)` |
| `test_consonant_skeleton_arabic_matches_latin` | method | `tests/test_entity_resolution.py:54` | `def test_consonant_skeleton_arabic_matches_latin(self)` |
| `test_consonant_skeleton_gemination` | method | `tests/test_entity_resolution.py:57` | `def test_consonant_skeleton_gemination(self)` |
| `test_cross_run_id_stability` | method | `tests/test_entity_resolution.py:451` | `def test_cross_run_id_stability(self)` |
| `test_cross_script_flagged_in_attributes` | method | `tests/test_entity_resolution.py:180` | `def test_cross_script_flagged_in_attributes(self)` |
| `test_cve_uppered` | method | `tests/test_entity_resolution.py:107` | `def test_cve_uppered(self)` |
| `test_cyrillic_to_latin` | method | `tests/test_entity_resolution.py:45` | `def test_cyrillic_to_latin(self)` |
| `test_deterministic` | method | `tests/test_entity_resolution.py:136` | `def test_deterministic(self)` |
| `test_deterministic_near_miss_never_matches` | method | `tests/test_entity_resolution.py:249` | `def test_deterministic_near_miss_never_matches(self)` |
| `test_diacritic_fold` | method | `tests/test_entity_resolution.py:51` | `def test_diacritic_fold(self)` |
| `test_different_normalised_different_id` | method | `tests/test_entity_resolution.py:409` | `def test_different_normalised_different_id(self)` |
| `test_different_values_different_ids` | method | `tests/test_entity_resolution.py:141` | `def test_different_values_different_ids(self)` |
| `test_dissimilar_strings_score_low` | method | `tests/test_entity_resolution.py:81` | `def test_dissimilar_strings_score_low(self)` |
| `test_distinct_names_have_distinct_skeletons` | method | `tests/test_entity_resolution.py:60` | `def test_distinct_names_have_distinct_skeletons(self)` |
| `test_distinct_persons_not_absorbed` | method | `tests/test_entity_resolution.py:329` | `def test_distinct_persons_not_absorbed(self)` |
| `test_domain_case_variants_merge` | method | `tests/test_entity_resolution.py:197` | `def test_domain_case_variants_merge(self)` |
| `test_domain_merge_is_exact` | method | `tests/test_entity_resolution.py:207` | `def test_domain_merge_is_exact(self)` |
| `test_domain_strips_scheme_www_path` | method | `tests/test_entity_resolution.py:110` | `def test_domain_strips_scheme_www_path(self)` |
| `test_email_lowered` | method | `tests/test_entity_resolution.py:129` | `def test_email_lowered(self)` |
| `test_empty_input_returns_empty` | method | `tests/test_entity_resolution.py:385` | `def test_empty_input_returns_empty(self)` |
| `test_empty_pair_scores_zero` | method | `tests/test_entity_resolution.py:74` | `def test_empty_pair_scores_zero(self)` |
| `test_fused_identity_carries_all_sources` | method | `tests/test_entity_resolution.py:169` | `def test_fused_identity_carries_all_sources(self)` |
| `test_greek_accented_to_latin` | method | `tests/test_entity_resolution.py:48` | `def test_greek_accented_to_latin(self)` |
| `test_hash_lowered` | method | `tests/test_entity_resolution.py:101` | `def test_hash_lowered(self)` |
| `test_id_format` | method | `tests/test_entity_resolution.py:146` | `def test_id_format(self)` |
| `test_identical_ips_merge` | method | `tests/test_entity_resolution.py:275` | `def test_identical_ips_merge(self)` |
| `test_identical_strings_score_one` | method | `tests/test_entity_resolution.py:71` | `def test_identical_strings_score_one(self)` |
| `test_ipv4_normalised` | method | `tests/test_entity_resolution.py:92` | `def test_ipv4_normalised(self)` |
| `test_ipv6_compressed` | method | `tests/test_entity_resolution.py:95` | `def test_ipv6_compressed(self)` |
| `test_look_alike_domains_produce_same_as_link` | method | `tests/test_entity_resolution.py:233` | `def test_look_alike_domains_produce_same_as_link(self)` |
| `test_look_alike_domains_stay_separate` | method | `tests/test_entity_resolution.py:224` | `def test_look_alike_domains_stay_separate(self)` |
| `test_near_ips_stay_separate` | method | `tests/test_entity_resolution.py:292` | `def test_near_ips_stay_separate(self)` |
| `test_non_latin_detector` | method | `tests/test_entity_resolution.py:63` | `def test_non_latin_detector(self)` |
| `test_org_suffix_stripped` | method | `tests/test_entity_resolution.py:121` | `def test_org_suffix_stripped(self)` |
| `test_org_suffix_variants_merge` | method | `tests/test_entity_resolution.py:312` | `def test_org_suffix_variants_merge(self)` |
| `test_person_order_independent` | method | `tests/test_entity_resolution.py:116` | `def test_person_order_independent(self)` |
| `test_resolution_result_has_one_entity` | method | `tests/test_entity_resolution.py:373` | `def test_resolution_result_has_one_entity(self)` |
| `test_same_normalised_same_id` | method | `tests/test_entity_resolution.py:397` | `def test_same_normalised_same_id(self)` |
| `test_score_pair_deterministic_mismatch` | method | `tests/test_entity_resolution.py:259` | `def test_score_pair_deterministic_mismatch(self)` |
| `test_scores_stay_in_unit_interval` | method | `tests/test_entity_resolution.py:84` | `def test_scores_stay_in_unit_interval(self)` |
| `test_single_entity_produces_one_canonical` | method | `tests/test_entity_resolution.py:429` | `def test_single_entity_produces_one_canonical(self)` |
| `test_three_spellings_fuse` | method | `tests/test_entity_resolution.py:158` | `def test_three_spellings_fuse(self)` |
| `test_to_dict_serialises` | method | `tests/test_entity_resolution.py:350` | `def test_to_dict_serialises(self)` |
| `test_to_entity_projects_legacy` | method | `tests/test_entity_resolution.py:361` | `def test_to_entity_projects_legacy(self)` |
| `test_whitespace_only_handled` | method | `tests/test_entity_resolution.py:425` | `def test_whitespace_only_handled(self)` |
| `TestBoundaryConditions` | class | `tests/test_fusion_analytics.py:281` | `class TestBoundaryConditions` |
| `TestCorroboratedProperties` | class | `tests/test_fusion_analytics.py:176` | `class TestCorroboratedProperties` |
| `TestEntitySearch` | class | `tests/test_fusion_analytics.py:195` | `class TestEntitySearch` |
| `TestEntitySummary` | class | `tests/test_fusion_analytics.py:87` | `class TestEntitySummary` |
| `TestEntityTimeline` | class | `tests/test_fusion_analytics.py:64` | `class TestEntityTimeline` |
| `TestEntityTimelineNonexistent` | class | `tests/test_fusion_analytics.py:109` | `class TestEntityTimelineNonexistent` |
| `TestMultiSourceConsensus` | class | `tests/test_fusion_analytics.py:155` | `class TestMultiSourceConsensus` |
| `TestSourceCorroborationMatrix` | class | `tests/test_fusion_analytics.py:250` | `class TestSourceCorroborationMatrix` |
| `TestSourceStats` | class | `tests/test_fusion_analytics.py:118` | `class TestSourceStats` |
| `TestTopChanged` | class | `tests/test_fusion_analytics.py:230` | `class TestTopChanged` |
| `TestWithNoneStore` | class | `tests/test_fusion_analytics.py:268` | `class TestWithNoneStore` |
| `_populate_evilcorp` | function | `tests/test_fusion_analytics.py:42` | `def _populate_evilcorp(store)` |
| `_register_source` | function | `tests/test_fusion_analytics.py:57` | `def _register_source(store, name)` |
| `store_and_analytics` | function | `tests/test_fusion_analytics.py:27` | `def store_and_analytics(tmp_path)` |
| `test_all_methods_return_empty` | method | `tests/test_fusion_analytics.py:269` | `def test_all_methods_return_empty(self)` |
| `test_consensus_picks_majority_value` | method | `tests/test_fusion_analytics.py:156` | `def test_consensus_picks_majority_value(self, store_and_analytics)` |
| `test_empty_window_returns_empty` | method | `tests/test_fusion_analytics.py:241` | `def test_empty_window_returns_empty(self, store_and_analytics)` |
| `test_filters_by_min_sources` | method | `tests/test_fusion_analytics.py:177` | `def test_filters_by_min_sources(self, store_and_analytics)` |
| `test_min_sources_one_returns_all` | method | `tests/test_fusion_analytics.py:185` | `def test_min_sources_one_returns_all(self, store_and_analytics)` |
| `test_min_sources_zero_treated_as_one` | method | `tests/test_fusion_analytics.py:282` | `def test_min_sources_zero_treated_as_one(self, store_and_analytics)` |
| `test_negative_days_treated_as_one` | method | `tests/test_fusion_analytics.py:288` | `def test_negative_days_treated_as_one(self, store_and_analytics)` |
...
| `TestCredentialsRedacted` | class | `tests/test_recon_report.py:91` | `class TestCredentialsRedacted` |
...
| `TestRecommendationsOrdered` | class | `tests/test_recon_report.py:83` | `class TestRecommendationsOrdered` |
| `TestSingleFindingReport` | class | `tests/test_recon_report.py:118` | `class TestSingleFindingReport` |
| `TestSubdomainTree` | class | `tests/test_recon_report.py:104` | `class TestSubdomainTree` |
...
| `test_ascii_tree_generated` | method | `tests/test_recon_report.py:105` | `def test_ascii_tree_generated(self)` |
| `test_aws_key_redacted` | method | `tests/test_recon_report.py:92` | `def test_aws_key_redacted(self)` |
| `test_contains_all_sections` | method | `tests/test_recon_report.py:29` | `def test_contains_all_sections(self)` |
| `test_critical_first` | method | `tests/test_recon_report.py:84` | `def test_critical_first(self)` |
...
| `test_password_redacted` | method | `tests/test_recon_report.py:97` | `def test_password_redacted(self)` |
| `test_single_finding_prominent` | method | `tests/test_recon_report.py:119` | `def test_single_finding_prominent(self)` |
| `test_tlp_amber_in_header` | method | `tests/test_recon_report.py:73` | `def test_tlp_amber_in_header(self)` |
| `TestBoundedSmoke` | class | `tests/test_reliability_scoring.py:453` | `class TestBoundedSmoke` |
| `TestDeterminism` | class | `tests/test_reliability_scoring.py:412` | `class TestDeterminism` |
| `TestHappyPathHighReliabilityCorroboratedFresh` | class | `tests/test_reliability_scoring.py:45` | `class TestHappyPathHighReliabilityCorroboratedFresh` |
| `TestHostileSourceNameIsHandledSafely` | class | `tests/test_reliability_scoring.py:270` | `class TestHostileSourceNameIsHandledSafely` |
| `TestInvalidInputRaisesValueError` | class | `tests/test_reliability_scoring.py:225` | `class TestInvalidInputRaisesValueError` |
| `TestMergeReliableBeatsLessReliable` | class | `tests/test_reliability_scoring.py:299` | `class TestMergeReliableBeatsLessReliable` |
| `TestMergeUnreliableCannotRaise` | class | `tests/test_reliability_scoring.py:366` | `class TestMergeUnreliableCannotRaise` |
| `TestSourceHierarchyInMerge` | class | `tests/test_reliability_scoring.py:628` | `class TestSourceHierarchyInMerge` |
| `TestSourceHierarchyPrimaryBeatsSecondaryBeatsTertiary` | class | `tests/test_reliability_scoring.py:483` | `class TestSourceHierarchyPrimaryBeatsSecondaryBeatsTertiary` |
| `TestSourceHierarchyPrimaryCBeatsTertiaryA` | class | `tests/test_reliability_scoring.py:550` | `class TestSourceHierarchyPrimaryCBeatsTertiaryA` |
| `TestSourceTypeFromName` | class | `tests/test_reliability_scoring.py:594` | `class TestSourceTypeFromName` |
| `TestSourceTypeWeightsBounded` | class | `tests/test_reliability_scoring.py:662` | `class TestSourceTypeWeightsBounded` |
| `TestUnknownSourceFallsBackToDefault` | class | `tests/test_reliability_scoring.py:109` | `class TestUnknownSourceFallsBackToDefault` |
| `TestVeryOldObservationDecaysToZero` | class | `tests/test_reliability_scoring.py:188` | `class TestVeryOldObservationDecaysToZero` |
| `TestZeroCorroborationYieldsZeroScore` | class | `tests/test_reliability_scoring.py:169` | `class TestZeroCorroborationYieldsZeroScore` |
| `test_base_confidence_out_of_range_raises` | method | `tests/test_reliability_scoring.py:243` | `def test_base_confidence_out_of_range_raises(self, bad)` |
| `test_compute_confidence_is_pure` | method | `tests/test_reliability_scoring.py:415` | `def test_compute_confidence_is_pure(self)` |
| `test_corroboration_weight_matches_log10` | method | `tests/test_reliability_scoring.py:86` | `def test_corroboration_weight_matches_log10(self)` |
| `test_credibility_weight_for_probably_true` | method | `tests/test_reliability_scoring.py:95` | `def test_credibility_weight_for_probably_true(self)` |
| `test_credibility_weights_match_nato_admiralty` | method | `tests/test_reliability_scoring.py:465` | `def test_credibility_weights_match_nato_admiralty(self)` |
| `test_default_credibility_is_cannot_be_judged` | method | `tests/test_reliability_scoring.py:476` | `def test_default_credibility_is_cannot_be_judged(self)` |
| `test_default_half_life_is_thirty_days` | method | `tests/test_reliability_scoring.py:473` | `def test_default_half_life_is_thirty_days(self)` |
| `test_empty_falls_back` | method | `tests/test_reliability_scoring.py:615` | `def test_empty_falls_back(self)` |
| `test_f_source_against_strong_existing_keeps_existing` | method | `tests/test_reliability_scoring.py:369` | `def test_f_source_against_strong_existing_keeps_existing(self)` |
| `test_freshness_is_monotonically_decreasing` | method | `tests/test_reliability_scoring.py:204` | `def test_freshness_is_monotonically_decreasing(self)` |
| `test_freshness_weight_is_one_when_age_zero` | method | `tests/test_reliability_scoring.py:76` | `def test_freshness_weight_is_one_when_age_zero(self)` |
| `test_half_life_negative_raises` | method | `tests/test_reliability_scoring.py:258` | `def test_half_life_negative_raises(self)` |
| `test_half_life_zero_raises` | method | `tests/test_reliability_scoring.py:250` | `def test_half_life_zero_raises(self)` |
| `test_hostile_input_does_not_raise` | method | `tests/test_reliability_scoring.py:618` | `def test_hostile_input_does_not_raise(self)` |
| `test_hostile_name_does_not_raise` | method | `tests/test_reliability_scoring.py:288` | `def test_hostile_name_does_not_raise(self, hostile)` |
| `test_leakcheck_is_tertiary` | method | `tests/test_reliability_scoring.py:600` | `def test_leakcheck_is_tertiary(self)` |
| `test_merge_confidence_is_pure` | method | `tests/test_reliability_scoring.py:428` | `def test_merge_confidence_is_pure(self)` |
| `test_merge_existing_out_of_range_raises` | method | `tests/test_reliability_scoring.py:384` | `def test_merge_existing_out_of_range_raises(self)` |
| `test_merge_keeps_existing_when_new_is_weaker` | method | `tests/test_reliability_scoring.py:335` | `def test_merge_keeps_existing_when_new_is_weaker(self)` |
| `test_merge_new_observation_out_of_range_raises` | method | `tests/test_reliability_scoring.py:396` | `def test_merge_new_observation_out_of_range_raises(self)` |
| `test_merge_result_is_always_bounded` | method | `tests/test_reliability_scoring.py:350` | `def test_merge_result_is_always_bounded(self)` |
| `test_merge_takes_max_of_existing_and_new` | method | `tests/test_reliability_scoring.py:319` | `def test_merge_takes_max_of_existing_and_new(self)` |
| `test_negative_corroboration_count_raises` | method | `tests/test_reliability_scoring.py:228` | `def test_negative_corroboration_count_raises(self)` |
| `test_negative_observation_age_raises` | method | `tests/test_reliability_scoring.py:235` | `def test_negative_observation_age_raises(self)` |
| `test_new_a_source_raises_score` | method | `tests/test_reliability_scoring.py:302` | `def test_new_a_source_raises_score(self)` |
| `test_new_primary_raises_score` | method | `tests/test_reliability_scoring.py:631` | `def test_new_primary_raises_score(self)` |
| `test_new_tertiary_does_not_raise_weak_existing` | method | `tests/test_reliability_scoring.py:644` | `def test_new_tertiary_does_not_raise_weak_existing(self)` |
| `test_none_falls_back` | method | `tests/test_reliability_scoring.py:612` | `def test_none_falls_back(self)` |
| `test_one_year_old_with_low_corroboration_decays` | method | `tests/test_reliability_scoring.py:191` | `def test_one_year_old_with_low_corroboration_decays(self)` |
| `test_primary_always_gives_one` | method | `tests/test_reliability_scoring.py:670` | `def test_primary_always_gives_one(self)` |
| `test_primary_c_beats_tertiary_a` | method | `tests/test_reliability_scoring.py:553` | `def test_primary_c_beats_tertiary_a(self)` |
| `test_primary_c_weight` | method | `tests/test_reliability_scoring.py:580` | `def test_primary_c_weight(self)` |
| `test_primary_tertiary_score_order` | method | `tests/test_reliability_scoring.py:486` | `def test_primary_tertiary_score_order(self)` |
| `test_primary_weight_is_one` | method | `tests/test_reliability_scoring.py:519` | `def test_primary_weight_is_one(self)` |
| `test_rdap_is_primary` | method | `tests/test_reliability_scoring.py:597` | `def test_rdap_is_primary(self)` |
| `test_reliability_weight_is_one` | method | `tests/test_reliability_scoring.py:67` | `def test_reliability_weight_is_one(self)` |
| `test_reliability_weights_match_nato_admiralty` | method | `tests/test_reliability_scoring.py:456` | `def test_reliability_weights_match_nato_admiralty(self)` |
| `test_score_in_high_band` | method | `tests/test_reliability_scoring.py:48` | `def test_score_in_high_band(self)` |
| `test_secondary_weight_is_085` | method | `tests/test_reliability_scoring.py:528` | `def test_secondary_weight_is_085(self)` |
| `test_shodan_is_secondary` | method | `tests/test_reliability_scoring.py:606` | `def test_shodan_is_secondary(self)` |
| `test_source_type_weights_are_exact` | method | `tests/test_reliability_scoring.py:665` | `def test_source_type_weights_are_exact(self)` |
| `test_tertiary_always_gives_060` | method | `tests/test_reliability_scoring.py:679` | `def test_tertiary_always_gives_060(self)` |
| `test_tertiary_weight_is_060` | method | `tests/test_reliability_scoring.py:537` | `def test_tertiary_weight_is_060(self)` |
| `test_unknown_falls_back_to_default` | method | `tests/test_reliability_scoring.py:609` | `def test_unknown_falls_back_to_default(self)` |
| `test_unknown_source_produces_weak_score_with_one_corroboration` | method | `tests/test_reliability_scoring.py:126` | `def test_unknown_source_produces_weak_score_with_one_corroboration(self)` |
| `test_unknown_source_returns_default` | method | `tests/test_reliability_scoring.py:120` | `def test_unknown_source_returns_default(self, name)` |
| `test_unknown_source_with_many_corroborators_reaches_high_band` | method | `tests/test_reliability_scoring.py:146` | `def test_unknown_source_with_many_corroborators_reaches_high_band(self)` |
| `test_wikidata_is_secondary` | method | `tests/test_reliability_scoring.py:603` | `def test_wikidata_is_secondary(self)` |
| `test_zero_corroboration_collapses_score` | method | `tests/test_reliability_scoring.py:172` | `def test_zero_corroboration_collapses_score(self)` |
...
| `TestAlerterSsrf` | class | `tests/test_security_remediation.py:497` | `class TestAlerterSsrf` |
...
| `test_refuses_disallowed_scheme` | method | `tests/test_security_remediation.py:511` | `def test_refuses_disallowed_scheme(self)` |
| `test_refuses_link_local_metadata` | method | `tests/test_security_remediation.py:502` | `def test_refuses_link_local_metadata(self)` |
| `test_refuses_loopback` | method | `tests/test_security_remediation.py:507` | `def test_refuses_loopback(self)` |
| `test_selectnode_inspector_safe` | method | `tests/test_security_remediation.py:473` | `def test_selectnode_inspector_safe(self)` |
...
| `test_user_channel_url_cannot_reach_internal_host` | method | `tests/test_security_remediation.py:515` | `def test_user_channel_url_cannot_reach_internal_host(self)` |
...
| `TestBatchResultSerialization` | class | `tests/test_target_management.py:367` | `class TestBatchResultSerialization` |
| `TestCsvImport` | class | `tests/test_target_management.py:410` | `class TestCsvImport` |
| `TestMakeTargetId` | class | `tests/test_target_management.py:333` | `class TestMakeTargetId` |
| `TestS10Determinism` | class | `tests/test_target_management.py:246` | `class TestS10Determinism` |
| `TestS1HappyPath` | class | `tests/test_target_management.py:21` | `class TestS1HappyPath` |
| `TestS2AutoDetect` | class | `tests/test_target_management.py:46` | `class TestS2AutoDetect` |
| `TestS3InvalidValue` | class | `tests/test_target_management.py:113` | `class TestS3InvalidValue` |
| `TestS4UnknownType` | class | `tests/test_target_management.py:140` | `class TestS4UnknownType` |
| `TestS5EmptyValue` | class | `tests/test_target_management.py:156` | `class TestS5EmptyValue` |
| `TestS6CaseStoreUnavailable` | class | `tests/test_target_management.py:174` | `class TestS6CaseStoreUnavailable` |
| `TestS7Batch` | class | `tests/test_target_management.py:186` | `class TestS7Batch` |
| `TestS8MaxBatch` | class | `tests/test_target_management.py:211` | `class TestS8MaxBatch` |
| `TestS9XSS` | class | `tests/test_target_management.py:228` | `class TestS9XSS` |
| `TestTargetResultSerialization` | class | `tests/test_target_management.py:379` | `class TestTargetResultSerialization` |
| `TestValidateType` | class | `tests/test_target_management.py:266` | `class TestValidateType` |
| `TestValidateValue` | class | `tests/test_target_management.py:280` | `class TestValidateValue` |
| `test_asn_auto` | method | `tests/test_target_management.py:92` | `def test_asn_auto(self)` |
| `test_asn_valid` | method | `tests/test_target_management.py:322` | `def test_asn_valid(self)` |
| `test_at_max` | method | `tests/test_target_management.py:217` | `def test_at_max(self)` |
| `test_auto_passes` | method | `tests/test_target_management.py:272` | `def test_auto_passes(self)` |
| `test_basic_csv` | method | `tests/test_target_management.py:411` | `def test_basic_csv(self)` |
| `test_btc_auto` | method | `tests/test_target_management.py:67` | `def test_btc_auto(self)` |
| `test_btc_valid` | method | `tests/test_target_management.py:313` | `def test_btc_valid(self)` |
| `test_case_sensitive_normalised` | method | `tests/test_target_management.py:340` | `def test_case_sensitive_normalised(self)` |
| `test_csv_exceeds_max` | method | `tests/test_target_management.py:431` | `def test_csv_exceeds_max(self)` |
| `test_csv_invalid` | method | `tests/test_target_management.py:418` | `def test_csv_invalid(self)` |
| `test_csv_max_batch` | method | `tests/test_target_management.py:425` | `def test_csv_max_batch(self)` |
| `test_cve` | method | `tests/test_target_management.py:360` | `def test_cve(self)` |
| `test_cve_auto` | method | `tests/test_target_management.py:62` | `def test_cve_auto(self)` |
| `test_cve_valid` | method | `tests/test_target_management.py:310` | `def test_cve_valid(self)` |
| `test_deterministic` | method | `tests/test_target_management.py:337` | `def test_deterministic(self)` |
| `test_domain` | method | `tests/test_target_management.py:354` | `def test_domain(self)` |
| `test_domain_auto` | method | `tests/test_target_management.py:77` | `def test_domain_auto(self)` |
| `test_domain_invalid` | method | `tests/test_target_management.py:285` | `def test_domain_invalid(self)` |
| `test_domain_valid` | method | `tests/test_target_management.py:281` | `def test_domain_valid(self)` |
| `test_email` | method | `tests/test_target_management.py:351` | `def test_email(self)` |
| `test_email_auto` | method | `tests/test_target_management.py:57` | `def test_email_auto(self)` |
| `test_email_valid` | method | `tests/test_target_management.py:297` | `def test_email_valid(self)` |
| `test_empty_raises` | method | `tests/test_target_management.py:157` | `def test_empty_raises(self)` |
| `test_ephemeral_no_case_store` | method | `tests/test_target_management.py:175` | `def test_ephemeral_no_case_store(self)` |
| `test_eth_auto` | method | `tests/test_target_management.py:72` | `def test_eth_auto(self)` |
| `test_eth_valid` | method | `tests/test_target_management.py:316` | `def test_eth_valid(self)` |
| `test_exceeds_max` | method | `tests/test_target_management.py:212` | `def test_exceeds_max(self)` |
| `test_has_case_id` | method | `tests/test_target_management.py:30` | `def test_has_case_id(self)` |
| `test_id_deterministic` | method | `tests/test_target_management.py:35` | `def test_id_deterministic(self)` |
| `test_invalid_domain_script` | method | `tests/test_target_management.py:123` | `def test_invalid_domain_script(self)` |
| `test_invalid_email` | method | `tests/test_target_management.py:114` | `def test_invalid_email(self)` |
| `test_invalid_fails` | method | `tests/test_target_management.py:275` | `def test_invalid_fails(self)` |
| `test_invalid_ipv4` | method | `tests/test_target_management.py:119` | `def test_invalid_ipv4(self)` |
| `test_invalid_phone` | method | `tests/test_target_management.py:131` | `def test_invalid_phone(self)` |
| `test_invalid_url` | method | `tests/test_target_management.py:127` | `def test_invalid_url(self)` |
| `test_ipv4` | method | `tests/test_target_management.py:345` | `def test_ipv4(self)` |
| `test_ipv4_auto` | method | `tests/test_target_management.py:47` | `def test_ipv4_auto(self)` |
| `test_ipv4_invalid_octet` | method | `tests/test_target_management.py:293` | `def test_ipv4_invalid_octet(self)` |
| `test_ipv4_valid` | method | `tests/test_target_management.py:289` | `def test_ipv4_valid(self)` |
| `test_ipv6` | method | `tests/test_target_management.py:348` | `def test_ipv6(self)` |
| `test_ipv6_auto` | method | `tests/test_target_management.py:52` | `def test_ipv6_auto(self)` |
| `test_length` | method | `tests/test_target_management.py:334` | `def test_length(self)` |
| `test_md5_auto` | method | `tests/test_target_management.py:97` | `def test_md5_auto(self)` |
| `test_md5_valid` | method | `tests/test_target_management.py:325` | `def test_md5_valid(self)` |
| `test_mixed_batch` | method | `tests/test_target_management.py:187` | `def test_mixed_batch(self)` |
| `test_onclick_in_domain_rejected` | method | `tests/test_target_management.py:233` | `def test_onclick_in_domain_rejected(self)` |
| `test_phone_auto` | method | `tests/test_target_management.py:87` | `def test_phone_auto(self)` |
| `test_phone_valid` | method | `tests/test_target_management.py:319` | `def test_phone_valid(self)` |
| `test_same_id` | method | `tests/test_target_management.py:247` | `def test_same_id(self)` |
| `test_same_id_normalised` | method | `tests/test_target_management.py:255` | `def test_same_id_normalised(self)` |
| `test_script_in_domain_rejected` | method | `tests/test_target_management.py:229` | `def test_script_in_domain_rejected(self)` |
| `test_sha256_auto` | method | `tests/test_target_management.py:102` | `def test_sha256_auto(self)` |
| `test_sha256_valid` | method | `tests/test_target_management.py:328` | `def test_sha256_valid(self)` |
| `test_simple_lines_no_type` | method | `tests/test_target_management.py:201` | `def test_simple_lines_no_type(self)` |
| `test_sql_injection_in_email_rejected` | method | `tests/test_target_management.py:237` | `def test_sql_injection_in_email_rejected(self)` |
| `test_to_dict` | method | `tests/test_target_management.py:368` | `def test_to_dict(self)` |
| `test_to_dict` | method | `tests/test_target_management.py:380` | `def test_to_dict(self)` |
| `test_to_dict_invalid` | method | `tests/test_target_management.py:397` | `def test_to_dict_invalid(self)` |
| `test_unknown_type` | method | `tests/test_target_management.py:141` | `def test_unknown_type(self)` |
| `test_unknown_type_via_manager` | method | `tests/test_target_management.py:146` | `def test_unknown_type_via_manager(self)` |
| `test_url` | method | `tests/test_target_management.py:357` | `def test_url(self)` |
| `test_url_only_http_https` | method | `tests/test_target_management.py:301` | `def test_url_only_http_https(self)` |
| `test_username_fallback` | method | `tests/test_target_management.py:82` | `def test_username_fallback(self)` |
| `test_username_fallback` | method | `tests/test_target_management.py:363` | `def test_username_fallback(self)` |
| `test_username_no_regex` | method | `tests/test_target_management.py:306` | `def test_username_no_regex(self)` |
| `test_valid_target_returns_result` | method | `tests/test_target_management.py:22` | `def test_valid_target_returns_result(self)` |
| `test_valid_types_pass` | method | `tests/test_target_management.py:267` | `def test_valid_types_pass(self)` |
| `test_validate_value_empty` | method | `tests/test_target_management.py:165` | `def test_validate_value_empty(self)` |
| `test_whitespace_raises` | method | `tests/test_target_management.py:161` | `def test_whitespace_raises(self)` |
| `TestConfigurableWeights` | class | `tests/test_target_scoring.py:70` | `class TestConfigurableWeights` |
| `TestCriticalTarget` | class | `tests/test_target_scoring.py:36` | `class TestCriticalTarget` |
| `TestCrownJewelDetection` | class | `tests/test_target_scoring.py:82` | `class TestCrownJewelDetection` |
| `TestLateralPotential` | class | `tests/test_target_scoring.py:101` | `class TestLateralPotential` |
| `TestMixedScoring` | class | `tests/test_target_scoring.py:52` | `class TestMixedScoring` |
| `TestNoCredentialLeakage` | class | `tests/test_target_scoring.py:108` | `class TestNoCredentialLeakage` |
| `TestNoFindingsNoise` | class | `tests/test_target_scoring.py:44` | `class TestNoFindingsNoise` |
| `TestPartialData` | class | `tests/test_target_scoring.py:94` | `class TestPartialData` |
| `_make_target` | function | `tests/test_target_scoring.py:17` | `def _make_target(domain, surface, soft, jewel, lateral)` |
| `test_5_targets_various_tiers` | method | `tests/test_target_scoring.py:53` | `def test_5_targets_various_tiers(self)` |
| `test_blog_low_jewel_score` | method | `tests/test_target_scoring.py:88` | `def test_blog_low_jewel_score(self)` |
| `test_custom_weights_change_score` | method | `tests/test_target_scoring.py:71` | `def test_custom_weights_change_score(self)` |
| `test_jenkins_jira_vpn_get_high_jewel_score` | method | `tests/test_target_scoring.py:83` | `def test_jenkins_jira_vpn_get_high_jewel_score(self)` |
| `test_no_findings_is_noise` | method | `tests/test_target_scoring.py:45` | `def test_no_findings_is_noise(self)` |
| `test_open_bucket_and_old_nginx_ranked_critical` | method | `tests/test_target_scoring.py:37` | `def test_open_bucket_and_old_nginx_ranked_critical(self)` |
| `test_partial_data_lower_confidence` | method | `tests/test_target_scoring.py:95` | `def test_partial_data_lower_confidence(self)` |
| `test_password_reuse_increases_lateral` | method | `tests/test_target_scoring.py:102` | `def test_password_reuse_increases_lateral(self)` |
| `test_serialised_output_no_credentials` | method | `tests/test_target_scoring.py:109` | `def test_serialised_output_no_credentials(self)` |
| `TestCmsDetection` | class | `tests/test_tech_fingerprint.py:69` | `class TestCmsDetection` |
| `TestDeduplication` | class | `tests/test_tech_fingerprint.py:80` | `class TestDeduplication` |
| `TestEmptyResponse` | class | `tests/test_tech_fingerprint.py:31` | `class TestEmptyResponse` |
| `TestHappyPathFullStack` | class | `tests/test_tech_fingerprint.py:15` | `class TestHappyPathFullStack` |
| `TestInputSizeBound` | class | `tests/test_tech_fingerprint.py:90` | `class TestInputSizeBound` |
| `TestMalformedVersion` | class | `tests/test_tech_fingerprint.py:39` | `class TestMalformedVersion` |
| `TestNoScriptInjection` | class | `tests/test_tech_fingerprint.py:49` | `class TestNoScriptInjection` |
| `TestWafDetection` | class | `tests/test_tech_fingerprint.py:58` | `class TestWafDetection` |
| `test_detects_cloudflare_from_headers` | method | `tests/test_tech_fingerprint.py:59` | `def test_detects_cloudflare_from_headers(self)` |
| `test_detects_nginx_php_jquery` | method | `tests/test_tech_fingerprint.py:16` | `def test_detects_nginx_php_jquery(self)` |
| `test_detects_wordpress_from_meta` | method | `tests/test_tech_fingerprint.py:70` | `def test_detects_wordpress_from_meta(self)` |
| `test_does_not_parse_script_as_tech` | method | `tests/test_tech_fingerprint.py:50` | `def test_does_not_parse_script_as_tech(self)` |
| `test_handles_binary_garbage_in_version` | method | `tests/test_tech_fingerprint.py:40` | `def test_handles_binary_garbage_in_version(self)` |
| `test_only_processes_first_100kb` | method | `tests/test_tech_fingerprint.py:91` | `def test_only_processes_first_100kb(self)` |
| `test_returns_empty_on_no_input` | method | `tests/test_tech_fingerprint.py:32` | `def test_returns_empty_on_no_input(self)` |
| `test_same_tech_from_multiple_signals_appears_once` | method | `tests/test_tech_fingerprint.py:81` | `def test_same_tech_from_multiple_signals_appears_once(self)` |
| `TestElevation` | class | `tests/test_tool_install.py:44` | `class TestElevation` |
| `TestInstallFlow` | class | `tests/test_tool_install.py:61` | `class TestInstallFlow` |
| `TestRecipes` | class | `tests/test_tool_install.py:24` | `class TestRecipes` |
| `no_network` | function | `tests/test_tool_install.py:17` | `def no_network()` |
| `test_already_installed_noop` | method | `tests/test_tool_install.py:62` | `def test_already_installed_noop(self, no_network)` |
| `test_apt_install_success` | method | `tests/test_tool_install.py:78` | `def test_apt_install_success(self)` |
| `test_git_install_runs_clone` | method | `tests/test_tool_install.py:95` | `def test_git_install_runs_clone(self)` |
| `test_list_recipes_is_nonempty` | method | `tests/test_tool_install.py:39` | `def test_list_recipes_is_nonempty(self)` |
| `test_load_apt_recipe` | method | `tests/test_tool_install.py:31` | `def test_load_apt_recipe(self)` |
| `test_load_git_recipe` | method | `tests/test_tool_install.py:35` | `def test_load_git_recipe(self)` |
| `test_no_elevation_when_root` | method | `tests/test_tool_install.py:55` | `def test_no_elevation_when_root(self)` |
| `test_no_recipe_rejected` | method | `tests/test_tool_install.py:72` | `def test_no_recipe_rejected(self)` |
| `test_not_in_allowlist_rejected` | method | `tests/test_tool_install.py:67` | `def test_not_in_allowlist_rejected(self)` |
| `test_recipe_available_for_known_tool` | method | `tests/test_tool_install.py:25` | `def test_recipe_available_for_known_tool(self)` |
| `test_recipe_unavailable_for_unknown_tool` | method | `tests/test_tool_install.py:28` | `def test_recipe_unavailable_for_unknown_tool(self)` |
| `test_run0_preferred_over_sudo` | method | `tests/test_tool_install.py:45` | `def test_run0_preferred_over_sudo(self)` |
| `test_sudo_fallback_when_no_run0` | method | `tests/test_tool_install.py:50` | `def test_sudo_fallback_when_no_run0(self)` |
| `test_verify_fails_after_install` | method | `tests/test_tool_install.py:89` | `def test_verify_fails_after_install(self, no_network)` |
| `TestConfidenceRange` | class | `tests/test_tool_runner.py:164` | `class TestConfidenceRange` |
| `TestErrorResultFields` | class | `tests/test_tool_runner.py:184` | `class TestErrorResultFields` |
| `TestHappyPathNmap` | class | `tests/test_tool_runner.py:20` | `class TestHappyPathNmap` |
| `TestInjectionBlocked` | class | `tests/test_tool_runner.py:29` | `class TestInjectionBlocked` |
| `TestNoArgs` | class | `tests/test_tool_runner.py:129` | `class TestNoArgs` |
| `TestNonZeroExit` | class | `tests/test_tool_runner.py:147` | `class TestNonZeroExit` |
| `TestOutputSha1` | class | `tests/test_tool_runner.py:156` | `class TestOutputSha1` |
| `TestOutputTruncation` | class | `tests/test_tool_runner.py:171` | `class TestOutputTruncation` |
| `TestTargetValidation` | class | `tests/test_tool_runner.py:141` | `class TestTargetValidation` |
| `TestTimeout` | class | `tests/test_tool_runner.py:81` | `class TestTimeout` |
| `TestToolNotAllowed` | class | `tests/test_tool_runner.py:117` | `class TestToolNotAllowed` |
| `TestToolNotFound` | class | `tests/test_tool_runner.py:96` | `class TestToolNotFound` |
| `test_backtick_in_arg_rejected` | method | `tests/test_tool_runner.py:50` | `def test_backtick_in_arg_rejected(self)` |
| `test_confidence_in_bounds` | method | `tests/test_tool_runner.py:165` | `def test_confidence_in_bounds(self)` |
| `test_control_char_rejected_by_validation` | method | `tests/test_tool_runner.py:142` | `def test_control_char_rejected_by_validation(self)` |
| `test_disallowed_tool_rejected` | method | `tests/test_tool_runner.py:118` | `def test_disallowed_tool_rejected(self)` |
| `test_dollar_paren_in_arg_rejected` | method | `tests/test_tool_runner.py:60` | `def test_dollar_paren_in_arg_rejected(self)` |
| `test_empty_args_returns_error` | method | `tests/test_tool_runner.py:130` | `def test_empty_args_returns_error(self)` |
| `test_error_result_has_fields` | method | `tests/test_tool_runner.py:185` | `def test_error_result_has_fields(self)` |
| `test_injection_error_has_fields` | method | `tests/test_tool_runner.py:206` | `def test_injection_error_has_fields(self)` |
| `test_newline_in_arg_rejected` | method | `tests/test_tool_runner.py:70` | `def test_newline_in_arg_rejected(self)` |
| `test_nmap_version_query_succeeds` | method | `tests/test_tool_runner.py:148` | `def test_nmap_version_query_succeeds(self)` |
| `test_pipe_in_arg_rejected` | method | `tests/test_tool_runner.py:40` | `def test_pipe_in_arg_rejected(self)` |
| `test_run_tool_returns_result` | method | `tests/test_tool_runner.py:21` | `def test_run_tool_returns_result(self)` |
| `test_semicolon_in_arg_rejected` | method | `tests/test_tool_runner.py:30` | `def test_semicolon_in_arg_rejected(self)` |
| `test_sha1_is_valid_hex` | method | `tests/test_tool_runner.py:157` | `def test_sha1_is_valid_hex(self)` |
